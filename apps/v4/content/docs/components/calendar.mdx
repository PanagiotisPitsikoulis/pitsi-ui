...
After upgrading the `Calendar` component, you can install the new blocks by running the `pitsi@latest add` command.

```bash
npx pitsi@latest add calendar-02
```
