...
eg. [https://v0.dev/chat/api/open?url=https://ui.pitsi.com/r/styles/new-york/login-01.json](https://v0.dev/chat/api/open?url=https://ui.pitsi.com/r/styles/new-york/login-01.json)
...
4. Both the pitsi CLI and Open in v0 will handle the 401 response and display an appropriate message to users
