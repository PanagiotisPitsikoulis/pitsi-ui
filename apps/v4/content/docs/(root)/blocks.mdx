...
```bash
git clone https://github.com/PanagiotisPitsikoulis/pitsi-ui.git
```
...
This follows the registry schema at [https://ui.pitsi.com/schema/registry-item.json](https://ui.pitsi.com/schema/registry-item.json).
...
export const blocks = [
  ...
  {
    name: "dashboard-01",
    author: "pitsi (https://ui.pitsi.com)",
    title: "Dashboard",
