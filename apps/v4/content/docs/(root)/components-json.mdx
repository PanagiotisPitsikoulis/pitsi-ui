...
You can see the JSON Schema for `components.json` [here](https://ui.pitsi.com/schema.json).
...
npx pitsi@latest add @private/button

# Install multiple resources
npx pitsi@latest add @acme/header @internal/auth-utils
```
...
{
  "registries": {
    "@pitsi": "https://ui.pitsi.com/r/{name}.json",
    "@company-ui": {
...
- Install public components from pitsi/ui
