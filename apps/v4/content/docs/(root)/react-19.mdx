...
description: Using pitsi/ui with Next.js 15 and React 19.
---
...
Follow the instructions in the [installation guide](/docs/installation/next) to install pitsi/ui. No flags are needed.
...
If you have any questions, please [open an issue](https://github.com/PanagiotisPitsikoulis/ui/issues) on GitHub.
