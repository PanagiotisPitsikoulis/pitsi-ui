...
export default function AppCheckoutPage() {
  ...
  const tier = tierId
    ? getServiceTierById("mobile_app", tierId)
    : MOBILE_APP_TIERS[1]
          ...
          <div className="order-1 lg:order-2">
            <div className="bg-card rounded-xl border p-6">
              ...
              <p className="text-muted-foreground mb-6 text-sm">
                Tell us about your app idea. You can provide more details after
                checkout.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your app idea and the main features you need..."
                    rows={4}
