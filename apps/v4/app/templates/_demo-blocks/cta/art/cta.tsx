...
export function CTAArt() {
  const darkCardStyle = getTemplateThemeStyle("art", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join our community of art lovers. Get exclusive access to new collections, artist interviews, and special exhibitions.
            </p>
