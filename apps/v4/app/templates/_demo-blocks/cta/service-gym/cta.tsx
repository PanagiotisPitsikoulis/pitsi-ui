...
export function CTAServiceGym() {
  const darkCardStyle = getTemplateThemeStyle("service-gym", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Start your transformation today. Get a free 7-day trial and personalized workout plan. No commitment required.
            </p>
