...
export function CTAProductPlants() {
  const darkCardStyle = getTemplateThemeStyle("product-plants", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join thousands of plant lovers. Get 15% off your first order and receive exclusive care tips delivered to your inbox.
            </p>
