...
export function CTAServiceMarketing() {
  const darkCardStyle = getTemplateThemeStyle("service-marketing", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Get a free marketing audit and discover how we can help you scale. Join hundreds of businesses driving real results.
            </p>
