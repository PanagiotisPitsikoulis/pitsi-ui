...
export function CTAServiceRealEstate() {
  const darkCardStyle = getTemplateThemeStyle("service-real-estate", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Get exclusive access to new listings before they hit the market. Join our VIP list and let us help you find the perfect property.
            </p>
