...
export function CTAProductSkincare() {
  const darkCardStyle = getTemplateThemeStyle("product-skincare", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join our beauty community and get 20% off your first order. Discover personalized skincare routines and expert tips.
            </p>
