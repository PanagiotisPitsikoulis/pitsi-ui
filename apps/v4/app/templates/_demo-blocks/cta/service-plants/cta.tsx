      ...
      <div className="container px-6">
        ...
        >
          ...
          <div className="relative z-20 flex flex-col items-center px-8 py-16 md:py-24">
            <h2 className="font-display mb-6 text-center text-3xl font-bold text-foreground md:text-5xl">
              Start Your Plant Journey
            </h2>
            <p className="mb-10 max-w-xl text-center text-lg text-foreground/70">
            ...
            <div className="mx-auto flex w-full max-w-md flex-col gap-4 sm:flex-row">
              <input
                ...
                className={cn(
                  "h-12 flex-1 rounded-full border border-foreground/20 bg-foreground/10 px-6 text-foreground",
                  "placeholder:text-foreground/50 focus:ring-1 focus:ring-foreground/30 focus:outline-none"
                )}
              />
              <Button className="h-12 rounded-full bg-foreground px-8 text-background hover:bg-foreground/90">
                Subscribe
              </Button>
            </div>
          </div>
