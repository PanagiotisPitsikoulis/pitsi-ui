...
export function CTAServicePetSitting() {
  const darkCardStyle = getTemplateThemeStyle("service-pet-sitting", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join our pet parent community and get 15% off your first booking. Trusted care for your furry family members.
            </p>
