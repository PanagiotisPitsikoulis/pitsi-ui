...
export function CTABoat() {
  const darkCardStyle = getTemplateThemeStyle("boat", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join our crew and receive exclusive offers on yacht charters, sailing trips, and maritime experiences. Adventure awaits!
            </p>
