...
export function CTAServiceFashion() {
  const darkCardStyle = getTemplateThemeStyle("service-fashion", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join our fashion insider list and get exclusive access to new collections, styling tips, and 15% off your first purchase.
            </p>
