...
export function CTAServiceTattoo() {
  const darkCardStyle = getTemplateThemeStyle("service-tattoo", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Book a consultation with our award-winning artists. Join our community and get exclusive flash designs and special offers.
            </p>
