...
export function CTAAiSciFi() {
  const darkCardStyle = getTemplateThemeStyle("ai-sci-fi", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join the next generation of innovators. Get exclusive access to cutting-edge AI technology and be part of the revolution.
            </p>
