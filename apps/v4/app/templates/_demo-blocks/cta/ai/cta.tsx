...
export function CTAAi() {
  const darkCardStyle = getTemplateThemeStyle("ai", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Join thousands of companies leveraging AI to accelerate growth. Get early access to our platform and exclusive insights.
            </p>
