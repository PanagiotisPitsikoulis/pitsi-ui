...
export function CTAProductCoffee() {
  const darkCardStyle = getTemplateThemeStyle("product-coffee", "tinted", "dark")
      ...
      <div className="container px-6">
        ...
        >
          <div className="absolute inset-0">
            <Image
              src="/placeholders/blocks/product-coffee/1.webp"
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Subscribe to our coffee club and get 15% off your first order. Receive expertly roasted beans delivered fresh to your door.
            </p>
