...
export function CTAServicePsychologist() {
  const darkCardStyle = getTemplateThemeStyle("service-psychologist", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Take the first step towards better mental health. Schedule a free consultation and receive resources to support your well-being.
            </p>
