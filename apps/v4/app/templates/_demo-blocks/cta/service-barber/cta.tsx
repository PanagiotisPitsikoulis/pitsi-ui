...
export function CTAServiceBarber() {
  const darkCardStyle = getTemplateThemeStyle("service-barber", "tinted", "dark")
        ...
        >
          ...
          <div className="relative z-10 py-16 md:py-24 px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Book your appointment today and get 20% off your first visit. Join our VIP list for exclusive offers and priority booking.
            </p>
