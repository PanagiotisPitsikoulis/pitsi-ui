...
import { KnockoutText } from "../../_block_components"
import { useScrollContainer } from "../../_components"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/placeholders/blocks/service-plants/assets/decoration-2.svg')",
      ...
      <motion.div
        className="pointer-events-none absolute -bottom-48 -left-44 z-0 hidden lg:block"
        style={{ x: heroImageX }}
      >
      ...
      <div className="relative z-10 mt-8 h-[500px] w-full overflow-visible lg:hidden">
        <Image draggable={false}
          ...
          width={900}
          height={1080}
          className="absolute top-0 left-1/2 h-[700px] w-auto -translate-x-1/2 select-none pointer-events-none object-contain"
        />
      </div>
