...
export function FeaturesServicePlants4() {
  ...
  const features = [
    {
      title: "Care Tips",
      description: "Personalized advice tailored to your specific plant collection.",
      icon: Sparkles,
    },
    {
      title: "Expert Support",
      description: "Direct access to certified horticulturists when you need help.",
      icon: MessageCircle,
    },
    {
      title: "Plant Guides",
    ...
    },
    {
      ...
      description: "Step-by-step visual guides for proper plant care techniques.",
      icon: BookOpen,
    },
    {
      title: "Live Q&A",
