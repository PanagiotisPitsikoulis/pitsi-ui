...
export function PricingProductScifi() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Basic",
      price: "$199",
      description: "Entry-level technology",
      features: [
        "Neural interface adapter",
        "Standard processing core",
        "1TB quantum storage",
    ...
    },
    {
      ...
      features: [
        ...
        "Dual-core quantum processor",
        "5TB holographic storage",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Choose the perfect tech tier for your needs. Upgradable anytime.
          </p>
        </div>
