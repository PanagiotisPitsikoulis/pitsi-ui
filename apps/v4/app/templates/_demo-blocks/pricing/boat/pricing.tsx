...
export function PricingBoat() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Day Sail",
      price: "$299",
      description: "Perfect afternoon escape",
      features: [
        "4-hour charter",
        "Up to 6 passengers",
        "Light refreshments",
    ...
    {
      name: "Weekend Charter",
      price: "$1499",
      description: "Ultimate sailing adventure",
      features: [
        "2-day charter",
        "Up to 10 passengers",
        "All meals included",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Set sail on your perfect adventure. All packages customizable.
          </p>
        </div>
