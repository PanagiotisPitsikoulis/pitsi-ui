...
export function PricingServicePetSitting() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Drop-in",
      price: "$25",
      description: "Quick check-in visits",
      features: [
        "30-minute visit",
        "Feeding & water",
        "Basic playtime",
    ...
    },
    {
      name: "Overnight",
      price: "$75",
      description: "24-hour care & comfort",
      features: [
        "24-hour supervision",
        "All meals included",
        "Bedtime routine",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Loving care for your furry friends. Flexible scheduling available.
          </p>
        </div>
