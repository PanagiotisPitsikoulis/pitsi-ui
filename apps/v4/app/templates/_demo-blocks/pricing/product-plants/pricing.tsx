...
export function PricingProductPlants() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Luxury pot collection",
        "24/7 plant specialist",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Choose the perfect plan to grow your indoor jungle. Cancel anytime.
          </p>
        </div>
