...
export function PricingServicePsychologist() {
  ...
  const plans = [
    ...
    },
    {
      name: "Package",
      price: "$500",
      description: "5-session commitment",
      features: [
        "5 therapy sessions",
        "Save $100 total",
        "Priority booking",
    ...
    },
    {
      name: "Intensive",
      price: "$1,500",
      description: "Comprehensive care plan",
      features: [
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Professional mental health support. Insurance accepted. Sliding
            scale available.
          </p>
        </div>
