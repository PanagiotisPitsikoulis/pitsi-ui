...
export function PricingServiceHospitality() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Standard",
      price: "$250",
      description: "Comfortable stay essentials",
      features: [
        "Queen bed room",
        "Free WiFi",
    ...
    },
    {
      name: "Deluxe",
      price: "$450",
      description: "Enhanced comfort & amenities",
      features: [
        "King bed suite",
        "Free WiFi & parking",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Nightly rates for an unforgettable stay. Book direct for best
            prices.
          </p>
        </div>
