...
export function PricingServiceRealEstate() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Standard",
      price: "3%",
      description: "Full-service listing",
      features: [
        "MLS listing",
        "Professional photos",
        "Open houses",
    ...
    },
    {
      name: "Exclusive",
      price: "2%",
      description: "Luxury home specialist",
      features: [
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Transparent pricing for selling your home. Pay only when we sell.
          </p>
        </div>
