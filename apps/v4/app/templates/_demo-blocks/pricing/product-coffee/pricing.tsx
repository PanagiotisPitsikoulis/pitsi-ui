...
export function PricingProductCoffee() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Starter",
      price: "$24",
      description: "Begin your coffee journey",
      features: [
        "250g premium beans",
        "1 origin selection",
        "Roast notes guide",
    ...
    },
    {
      name: "Regular",
      price: "$39",
      description: "For the daily coffee lover",
      features: [
        "500g premium beans",
        "2 origin selections",
        "Tasting notes guide",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Fresh roasted beans delivered monthly. Cancel or pause anytime.
          </p>
        </div>
