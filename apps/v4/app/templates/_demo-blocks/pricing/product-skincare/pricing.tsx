...
export function PricingProductSkincare() {
  const { cardBg } = useBlockContext()
  const plans = [
    {
      name: "Essential",
      price: "$35",
      description: "Daily basics for healthy skin",
      features: [
        "Gentle cleanser",
    ...
    },
    {
      name: "Complete",
      price: "$65",
      description: "Full routine coverage",
      features: [
    ...
    },
    {
      name: "Luxury",
      price: "$120",
      description: "Premium skincare experience",
      features: [
        "7-step luxury routine",
      ...
      <div className="container px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
            Choose the perfect routine for your skin. Adjust products anytime.
          </p>
        </div>
