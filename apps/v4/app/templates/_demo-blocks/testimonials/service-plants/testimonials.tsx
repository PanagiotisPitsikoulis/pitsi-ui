    ...
    <section>
      <div className="container px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              quote: "My monstera arrived in perfect condition. It's been thriving for 6 months now!",
              author: "Sarah M.",
              role: "Plant Parent",
            },
            {
              quote: "The care guide that came with my plants was incredibly helpful. Best plant shop ever.",
              author: "James L.",
              role: "Home Designer",
            },
            {
              quote: "Finally found a shop that delivers healthy plants. Already ordered three times!",
              author: "Emma K.",
