...
export interface FeatureVideoCard {
  title: string
  image: string
}

export interface FeatureVideoCardsBlockProps {
  imageSrc?: string
  imageAlt?: string
  videoUrl?: string
  videoCaption?: string
  videoSecondaryCaption?: string
  cards?: FeatureVideoCard[]
  className?: string
}
...
export function FeatureVideoCardsBlock({
  imageSrc = defaultImageSrc,
  imageAlt = defaultImageAlt,
  videoUrl = defaultVideoUrl,
  videoCaption = defaultVideoCaption,
  videoSecondaryCaption = defaultVideoSecondaryCaption,
  cards = defaultCards,
  className,
}: FeatureVideoCardsBlockProps) {
