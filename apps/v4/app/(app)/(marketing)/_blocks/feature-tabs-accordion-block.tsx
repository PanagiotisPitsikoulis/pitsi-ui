...
export interface FeatureTabsAccordionBlockProps {
  features?: FeatureTabItem[]
  className?: string
}

const defaultFeatures: FeatureTabItem[] = [
  {
    id: 1,
...
export function FeatureTabsAccordionBlock({
  features = defaultFeatures,
  className,
}: FeatureTabsAccordionBlockProps) {
  return (
