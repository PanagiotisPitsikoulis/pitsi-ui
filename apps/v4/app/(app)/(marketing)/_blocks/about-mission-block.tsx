    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        <div className="grid grid-cols-1 gap-15 lg:grid-cols-7 lg:gap-1">
          <div className="relative col-span-4 h-120 border">
          ...
          <div className="col-span-3 ml-auto max-w-4xl space-y-15 lg:pl-15">
            ...
            <p className="text-foreground/40 text-base lg:text-lg">{subtext}</p>
            <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
              <p className="text-foreground/40 flex-1 text-sm">{quote}</p>
