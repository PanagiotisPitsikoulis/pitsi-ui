...
const COLOR_DESCRIPTIONS: Record<string, { title: string; description: string }> = {
  brand: {
    title: "Brand",
    description: "Your main brand color. Used for logos, key visual elements, and brand identity. This color represents your company or product.",
  },
  "brand-complementary": {
    title: "Brand Complementary",
    description: "A complementary accent to your brand color. Used for secondary branding, call-to-action highlights, and visual variety.",
  },
  primary: {
    title: "Primary",
    description: "The main interactive color. Used for buttons, links, and primary actions. Should have good contrast with its foreground.",
  },
  "primary-foreground": {
    title: "Primary Foreground",
    description: "Text and icon color on primary backgrounds. Must be highly legible against the primary color.",
  },
  secondary: {
    title: "Secondary",
    description: "Less prominent interactive elements. Used for secondary buttons, alternative actions, and supporting UI elements.",
  },
  "secondary-foreground": {
    title: "Secondary Foreground",
    description: "Text and icon color on secondary backgrounds. Provides readable contrast for secondary elements.",
  },
  accent: {
    title: "Accent",
    description: "Highlights and emphasis. Used for badges, tags, hover states, and elements that need visual distinction.",
  },
  "accent-foreground": {
    title: "Accent Foreground",
    description: "Text and icon color on accent backgrounds. Ensures readability on accent-colored elements.",
  },
  background: {
    title: "Background",
    description: "The main surface color of your app. Used for cards, modals, and content areas. Usually white or near-white in light mode.",
  },
  foreground: {
    title: "Foreground",
    description: "Default text color. Must have excellent contrast against the background for readability.",
  },
  page: {
    title: "Page",
    description: "The outermost background color. Creates depth by contrasting with card and content backgrounds.",
  },
  card: {
    title: "Card",
    description: "Surface color for cards and elevated content. Slightly different from background to create visual hierarchy.",
  },
  "card-foreground": {
    title: "Card Foreground",
    description: "Text color inside cards. Optimized for readability on card backgrounds.",
  },
  popover: {
    title: "Popover",
    description: "Background for dropdowns, tooltips, and floating elements. Often matches card color.",
  },
  "popover-foreground": {
    title: "Popover Foreground",
    description: "Text color inside popovers. Ensures clarity in floating UI elements.",
  },
  muted: {
    title: "Muted",
    description: "Subtle background for less prominent content. Used for disabled states, placeholders, and secondary areas.",
  },
  "muted-foreground": {
    title: "Muted Foreground",
    description: "Subdued text color. Used for placeholders, help text, and less important information.",
  },
  destructive: {
    title: "Destructive",
    description: "Danger and error states. Used for delete actions, error messages, and warnings. Typically red-based.",
  },
  "destructive-foreground": {
    title: "Destructive Foreground",
    description: "Text on destructive backgrounds. Must be clearly visible to communicate urgency.",
  },
  border: {
    title: "Border",
    description: "Default border color for dividers, separators, and element outlines. Subtle but visible.",
  },
  input: {
    title: "Input",
    description: "Border color for form inputs, text fields, and interactive form elements.",
  },
  ring: {
    title: "Ring",
    description: "Focus ring color. Appears around focused elements for accessibility. Usually matches primary or brand.",
  },
  "chart-1": {
    title: "Chart 1",
    description: "First color in data visualizations. Used for the primary data series in charts and graphs.",
  },
  "chart-2": {
    title: "Chart 2",
    description: "Second chart color. Distinguishes the second data series from the first.",
  },
  "chart-3": {
    title: "Chart 3",
    description: "Third chart color. Provides additional visual distinction in multi-series charts.",
  },
  "chart-4": {
    title: "Chart 4",
    description: "Fourth chart color. Extends the palette for complex data visualizations.",
  },
  "chart-5": {
    title: "Chart 5",
    description: "Fifth chart color. Completes the chart palette for diverse data sets.",
  },
  sidebar: {
    title: "Sidebar",
    description: "Background color for navigation sidebars. Can match or contrast with main content.",
  },
  "sidebar-foreground": {
    title: "Sidebar Foreground",
    description: "Text color in the sidebar. Optimized for the sidebar background.",
  },
  "sidebar-primary": {
    title: "Sidebar Primary",
    description: "Active or selected state in sidebar. Highlights the current navigation item.",
  },
  ...
  "sidebar-accent": {
    ...
    description: "Hover and subtle emphasis in sidebar. Indicates interactivity.",
  },
  ...
  "sidebar-ring": {
    title: "Sidebar Ring",
    description: "Focus indicator for sidebar elements. Aids keyboard navigation.",
  },
}

// Theme psychology descriptions
const THEME_PSYCHOLOGY: Record<string, { mood: string; description: string; bestFor: string }> = {
  slate: {
    mood: "Professional & Neutral",
    description: "A purely neutral palette that lets content speak for itself. Gray tones convey sophistication, reliability, and timelessness without any color bias.",
    bestFor: "Business apps, documentation, content-focused sites",
  },
  azure: {
    mood: "Trustworthy & Calm",
    description: "Blue evokes trust, stability, and professionalism. It's calming and dependable, making users feel secure and confident in your product.",
    bestFor: "Finance, healthcare, enterprise software, SaaS",
  },
  "azure-tinted": {
    mood: "Fresh & Airy",
    description: "Soft blue undertones create a light, breathable atmosphere while maintaining the trustworthy qualities of azure.",
    bestFor: "Productivity tools, cloud services, modern dashboards",
  },
  "azure-deep": {
    mood: "Bold & Authoritative",
    description: "Deep blue commands attention and conveys expertise. It's confident and assertive while remaining professional.",
    bestFor: "Corporate sites, premium services, authority brands",
  },
  violet: {
    mood: "Creative & Premium",
    description: "Purple represents creativity, luxury, and innovation. It sparks imagination and suggests premium quality.",
    bestFor: "Creative tools, luxury brands, innovative tech",
  },
  "violet-tinted": {
    mood: "Mystical & Subtle",
    description: "Gentle violet undertones add a touch of magic and creativity without overwhelming the interface.",
    bestFor: "Design tools, meditation apps, creative platforms",
  },
  "violet-deep": {
    mood: "Luxurious & Bold",
    description: "Rich purple creates a sense of opulence and exclusivity. It's dramatic and memorable.",
    bestFor: "Premium products, exclusive services, VIP features",
  },
  rose: {
    mood: "Warm & Approachable",
    description: "Pink/rose tones are warm, friendly, and inviting. They create emotional connection and feel personal.",
    bestFor: "Social apps, wellness, dating, lifestyle brands",
  },
  "rose-tinted": {
    mood: "Soft & Caring",
    description: "Gentle rose undertones add warmth and humanity to the interface, making technology feel more approachable.",
    bestFor: "Health apps, parenting tools, community platforms",
  },
  "rose-deep": {
    mood: "Passionate & Energetic",
    description: "Bold rose/magenta creates excitement and energy. It's passionate and attention-grabbing.",
    bestFor: "Fashion, beauty, entertainment, bold startups",
  },
  sage: {
    mood: "Natural & Balanced",
    description: "Green represents nature, growth, and harmony. It's refreshing, calming, and suggests sustainability.",
    bestFor: "Eco brands, wellness, finance (growth), agriculture",
  },
  "sage-tinted": {
    mood: "Fresh & Organic",
    description: "Subtle green undertones create a natural, organic feel that's easy on the eyes and promotes focus.",
    bestFor: "Note-taking apps, reading platforms, nature brands",
  },
  "sage-deep": {
    mood: "Earthy & Grounded",
    description: "Deep green is sophisticated and grounding. It conveys stability, prosperity, and environmental consciousness.",
    bestFor: "Sustainable brands, luxury outdoor, investment platforms",
  },
  amber: {
    mood: "Warm & Optimistic",
    description: "Yellow/amber radiates warmth, optimism, and energy. It's cheerful and draws attention naturally.",
    bestFor: "Food apps, children's products, positive messaging",
  },
  "amber-tinted": {
    mood: "Sunny & Inviting",
    description: "Soft golden undertones create a welcoming, comfortable atmosphere that feels like sunshine.",
    bestFor: "Travel apps, hospitality, friendly services",
  },
  "amber-deep": {
    mood: "Rich & Prestigious",
    description: "Deep gold/amber suggests wealth, quality, and premium value. It's warm but sophisticated.",
    bestFor: "Luxury goods, premium tiers, award programs",
  },
  cyan: {
    mood: "Fresh & Modern",
    description: "Cyan is refreshing, modern, and tech-forward. It combines the trust of blue with the freshness of green.",
    bestFor: "Tech startups, water/energy brands, innovation",
  },
  "cyan-tinted": {
    mood: "Cool & Clean",
    description: "Light cyan undertones create a clean, clinical feel that's precise and focused.",
    bestFor: "Healthcare tech, cleaning services, precision tools",
  },
  "cyan-deep": {
    mood: "Oceanic & Deep",
    description: "Deep cyan/teal is mysterious and sophisticated. It suggests depth of knowledge and expertise.",
    bestFor: "Marine brands, deep tech, analytics platforms",
  },
  indigo: {
    mood: "Wise & Thoughtful",
    description: "Indigo combines blue's trust with purple's creativity. It's intellectual, intuitive, and contemplative.",
    bestFor: "Education, AI/ML products, research tools",
  },
  "indigo-tinted": {
    mood: "Dreamy & Intuitive",
    description: "Soft indigo undertones create a thoughtful, meditative atmosphere that encourages deep thinking.",
    bestFor: "Note apps, learning platforms, creative writing tools",
  },
  "indigo-deep": {
    mood: "Cosmic & Powerful",
    description: "Deep indigo is vast and powerful, evoking the night sky and infinite possibilities.",
    bestFor: "Space tech, advanced AI, visionary brands",
  },
  coral: {
    mood: "Vibrant & Energetic",
    description: "Coral is playful, energetic, and modern. It's warm like red but friendlier and more approachable.",
    bestFor: "Social apps, creative tools, trendy brands",
  },
  "coral-tinted": {
    mood: "Peachy & Friendly",
    description: "Soft coral undertones are warm and welcoming, creating a friendly, approachable environment.",
    bestFor: "Community apps, lifestyle brands, friendly services",
  },
  "coral-deep": {
    mood: "Bold & Adventurous",
    description: "Deep coral is bold and adventurous. It demands attention and conveys confidence.",
    bestFor: "Travel, adventure brands, bold startups",
  },
  forest: {
    mood: "Natural & Trustworthy",
    description: "Forest green is deep and natural. It represents growth, reliability, and environmental awareness.",
    bestFor: "Outdoor brands, eco-friendly products, nature apps",
  },
  "forest-tinted": {
    mood: "Mossy & Serene",
    description: "Subtle forest undertones create a serene, natural environment that promotes calm focus.",
    bestFor: "Meditation apps, nature guides, peaceful products",
  },
  "forest-deep": {
    mood: "Rich & Established",
    description: "Deep forest green is classic and established. It conveys heritage, quality, and enduring value.",
...
const previewBlocks = [
  { value: "marketing-hero-section-hero-section-with-customer-logos", label: "Hero with Logos" },
  { value: "marketing-hero-section-side-by-side-hero-section-with-image", label: "Hero Side by Side" },
  { value: "marketing-hero-section-simple-hero-section-with-creative-image", label: "Hero Creative" },
  { value: "marketing-hero-section-hero-section-with-gradient-background", label: "Hero Gradient" },
  { value: "marketing-hero-section-hero-section-with-stat-cards", label: "Hero with Stats" },
  { value: "marketing-features-default-feature-tailwind-css-block", label: "Features Default" },
  { value: "marketing-features-grid-layout-feature-cards", label: "Features Grid" },
  { value: "marketing-features-tailwind-feature-cards", label: "Features Cards" },
  { value: "marketing-features-two-column-feature-grid", label: "Features Two Column" },
  { value: "marketing-features-feature-section-with-card-layout", label: "Features Card Layout" },
  { value: "marketing-features-vertical-feature-card-with-tailwind-css", label: "Features Vertical" },
...
function ColorBox({ color }: { color: string }) {
  return (
    <div
      className="size-4 shrink-0 rounded-full border border-background ring-1 ring-border/50"
...
function ThemePsychologyButton({ themeKey, styles }: { themeKey: string; styles: ThemeStyleProps }) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <div className="flex -space-x-1">
              <div
                className="size-4 rounded-full border border-background ring-1 ring-border/50"
        ...
        <div className="rounded-lg border bg-muted/50 p-3">
          ...
          <p className="text-xs text-muted-foreground">{psychology.bestFor}</p>
        </div>
      </DialogContent>
    </Dialog>
  )
                  ...
                  {savedThemes.map((theme) => (
                    ...
                    >
                      <div className="flex -space-x-1.5">
                        ...
                        <ColorBox color={theme.styles[currentMode]["brand-complementary"]} />
                ...
                {Object.entries(presets).map(([key, preset]) => (
                  ...
                  >
                    <div className="flex -space-x-1.5">
                      ...
                      <ColorBox color={preset.styles[currentMode]["brand-complementary"]} />
...
export default function ThemeGeneratorPageClient({
  ...
  const [currentPreset, setCurrentPreset] = useQueryState("preset", presetParser)
  ...
  const [selectedBlock, setSelectedBlock] = useQueryState(
    "block",
    parseAsStringLiteral(previewBlockValues).withDefault("marketing-hero-section-hero-section-with-customer-logos")
  )
  ...
  const [themeStyles, setThemeStyles] = useState<ThemeStyles>(defaultState.styles)
  const [savedThemes, setSavedThemes, isHydrated] = useLocalStorage<SavedTheme[]>(STORAGE_KEYS.THEME_GENERATOR, [])
            ...
            >
              ...
              <ToolLayoutTabsContent value="colors">
                ...
                <div className="space-y-0">
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, brand: open }))}
                  >
                    <ColorPicker
                      name="brand"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="brand-complementary" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, primary: open }))}
                  >
                    <ColorPicker
                      name="primary"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="primary-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, secondary: open }))}
                  >
                    <ColorPicker
                      name="secondary"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="secondary-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, accent: open }))}
                  >
                    <ColorPicker
                      name="accent"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="accent-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, base: open }))}
                  >
                    <ColorPicker
                      name="background"
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, card: open }))}
                  >
                    <ColorPicker
                      name="card"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="card-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, popover: open }))}
                  >
                    <ColorPicker
                      name="popover"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="popover-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, muted: open }))}
                  >
                    <ColorPicker
                      name="muted"
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="muted-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, destructive: open }))}
                  >
                    <ColorPicker
                      name="destructive"
                    ...
                    <ColorPicker
                      ...
                      highlighted={highlightedColor === "destructive-foreground"}
                      infoButton={<ColorInfoButton colorKey="destructive-foreground" />}
                    />
                  </ControlSection>
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, border: open }))}
                  >
                    <ColorPicker
                      name="border"
                  ...
                  <ControlSection
                    ...
                    onOpenChange={(open) => setOpenSections((prev) => ({ ...prev, chart: open }))}
                  >
                    <ColorPicker
                      name="chart-1"
                  ...
                  >
                    ...
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="sidebar-foreground" />}
                    />
                    <ColorPicker
                      ...
                      infoButton={<ColorInfoButton colorKey="sidebar-primary" />}
                    />
                    <ColorPicker
                      ...
                      highlighted={highlightedColor === "sidebar-primary-foreground"}
                      infoButton={<ColorInfoButton colorKey="sidebar-primary-foreground" />}
                    />
                    <ColorPicker
                      name="sidebar-accent"
                    ...
                    <ColorPicker
                      ...
                      highlighted={highlightedColor === "sidebar-accent-foreground"}
                      infoButton={<ColorInfoButton colorKey="sidebar-accent-foreground" />}
                    />
                    <ColorPicker
                      name="sidebar-border"
              ...
              <ToolLayoutTabsContent value="export">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="h-7 w-24 bg-background text-xs shadow-2xs hover:bg-background">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2 pt-4">
                  <Button
                    ...
                    onClick={() => {
                      const json = generateFigmaColorVariables(currentStyles as unknown as Record<string, string>)
                  ...
                  <CodeBlock
                    code={generateFigmaColorVariables(currentStyles as unknown as Record<string, string>)}
                    language="json"
                ...
                <div className="flex h-full flex-col items-center justify-center">
                      ...
                      >
                        {Object.entries(presets).map(([key, preset]) => {
                          ...
                          const colorStrips = [
                            { key: "brand", label: "brand", fg: styles.background },
                            { key: "brand-complementary", label: "complementary", fg: styles.background },
                            { key: "primary", label: "primary", fg: styles["primary-foreground"] },
                            { key: "secondary", label: "secondary", fg: styles["secondary-foreground"] },
                            { key: "muted", label: "muted", fg: styles["muted-foreground"] },
                            { key: "card", label: "card", fg: styles["card-foreground"] },
                          ]
                          return (
                            <DeckItem key={key} className="p-0 shadow-sm rounded-[32px] overflow-hidden">
                              <div
                                className="relative flex size-full flex-col p-2 gap-1"
                                style={{ backgroundColor: styles.background }}
                              >
                                  {/* Psychology info button */}
                                  <ThemePsychologyButton themeKey={key} styles={styles} />
                                  {/* Color strips */}
                                  <div className="flex flex-1 flex-col overflow-hidden rounded-t-[24px]">
                                    {colorStrips.map((color) => (
                                      <div
                                        ...
                                        style={{
                                          backgroundColor: styles[color.key as keyof typeof styles],
                                        }}
                                      >
                                        <span
                                  ...
                                  <div className="flex justify-center px-1">
                                    <div className="flex items-center gap-2">
                                      <div className="flex -space-x-1.5">
                                        <div
                                          className="size-5 rounded-full border border-background ring-1 ring-border/50"
                                          style={{ backgroundColor: styles.brand }}
                                        />
                                        <div
                                          className="size-5 rounded-full border border-background ring-1 ring-border/50"
                                      ...
                                      <div className="-space-y-0.5">
                                        <h3 className="text-sm font-semibold leading-none tracking-tight" style={{ color: styles.foreground }}>{preset.label}</h3>
                                        <p className="text-[10px]" style={{ color: styles["muted-foreground"] }}>color palette</p>
                                      </div>
                                    </div>
                                  </div>
                              </div>
                      ...
                      <DeckEmpty>
                        <div className="text-center">
                          <p className="text-sm font-medium">All themes explored!</p>
                          <Button
                            variant="outline"
                            size="sm"
                            className="mt-2"
        ...
        <ToolLayoutPreview>
          <ToolLayoutPreviewHeader>
              ...
              <TooltipProvider delayDuration={0}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <span className={cn("text-sm font-medium tracking-wider uppercase", inspectorEnabled ? "text-brand" : "text-muted-foreground")}>
                        Inspector
                      </span>
                      <Inspect className={cn("size-3.5", inspectorEnabled ? "text-brand" : "text-muted-foreground")} />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    {inspectorEnabled
            ...
            <PreviewNavigation
              ...
              value={selectedBlock}
              onValueChange={(v) => setSelectedBlock(v as typeof previewBlockValues[number])}
            />
          </ToolLayoutPreviewHeader>
          ...
          <ToolLayoutPreviewContent
            className={cn(
              inspectorEnabled && "ring-brand/50 ring-2 border-transparent"
            )}
          >
            <LiveBlockPreview
              key={selectedBlock}
