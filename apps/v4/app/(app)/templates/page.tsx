...
const description =
  "Production-ready page templates and layouts. Copy, paste, and customize."
          ...
          <LayoutGridItem span={6} spanLg={2}>
            <div className="lg:sticky lg:top-24">
              ...
              <p className="text-muted-foreground text-base md:text-lg">
                Production-ready page templates and layouts. Copy, paste, and
                customize.
              </p>
              <Spacer size="6xl" sizeMobile="2xl" />
              <div className="flex justify-center">
                <TemplatesIcon className="text-brand w-48" />
              </div>
            </div>
          </LayoutGridItem>
