export default function EcommerceHeroSection() {
  return (
    <div>
      <nav className="top-0 left-0 z-50 w-full border-b border-gray-200 bg-white py-5 transition-all duration-500 lg:fixed">
    ...
    https://pagedone.io/"
      ...
      <section className="relative py-14 lg:pt-36 lg:pb-14">
        <div className="mx-auto mb-14 w-full max-w-7xl px-4 lg:px-8">
          <div className="mx-auto grid max-w-md grid-cols-1 gap-8 md:max-w-2xl lg:max-w-full lg:grid-cols-2">
            <div className="group relative cursor-pointer overflow-hidden rounded-2xl">
              ...
              />
              <div className="absolute top-0 left-0 z-10 h-full w-full rounded-2xl p-7">
                <h3 className="font-manrope text-5xl font-bold whitespace-nowrap text-white">
                  Nike Air Max
                </h3>
                <div className="flex h-full w-full items-end justify-end gap-2.5 pb-10">
                  <div className="flex items-center gap-2.5">
                    <button className="rounded-full bg-white px-6 py-2 text-base leading-8 font-semibold whitespace-nowrap text-black shadow-xs transition-all duration-500 hover:bg-black hover:text-white">
                      Explore All
                    </button>
                    <button className="flex h-12 w-12 items-center justify-center rounded-full bg-white text-xl leading-8 font-normal text-black transition-all duration-500 hover:bg-black hover:text-white">
                      {/* SVG removed */}
                    </button>
                  </div>
                </div>
            ...
            <div className="group relative cursor-pointer overflow-hidden rounded-2xl">
              <img
                ...
                className="relative z-0 h-full w-full rounded-2xl object-cover transition-all duration-700 group-hover:scale-105"
              />
              <div className="absolute top-0 left-0 z-10 h-full w-full rounded-2xl p-7">
                <div className="flex items-center justify-between gap-2.5">
                  ...
                  <button className="flex h-12 w-12 items-center justify-center rounded-full bg-white text-xl leading-8 font-normal text-black transition-all duration-500 group-hover:rotate-45 hover:bg-black hover:text-white">
                    {/* SVG removed */}
                  </button>
                </div>
                <div className="flex h-[calc(100%-70px)] w-full flex-col justify-end">
