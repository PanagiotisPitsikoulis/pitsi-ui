export default function HeroSectionWithStatisticsCarousel() {
  return (
    <div>
            ...
            >
              <ul className="flex flex-col gap-6 max-lg:mb-4 max-lg:pt-4 lg:mx-auto lg:mt-0 lg:flex-row lg:items-center lg:justify-center">
                <li>
                  <a
                    href="javascript:;"
                    className="nav-link block text-base font-medium text-gray-500 transition-all duration-500 hover:text-orange-700 md:mb-0 lg:mx-3 lg:text-left"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle mr-auto flex items-center justify-between text-center text-base font-medium text-gray-500 transition-all duration-500 hover:text-orange-700 lg:m-0 lg:mx-3 lg:mb-0 lg:text-left"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
              ...
              <div className="flex w-full flex-col justify-start gap-5 max-lg:gap-5 lg:ml-14 lg:w-max lg:flex-row lg:items-center lg:justify-end">
                <button className="flex cursor-pointer items-center justify-center rounded-lg bg-orange-600 px-3.5 py-2 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 hover:bg-orange-700">
      ...
      <section className="bg-gray-50 lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="gri-col-1 grid w-full items-center justify-start gap-5 py-10 lg:grid-cols-2 lg:gap-16 lg:py-20">
            <div className="flex w-full flex-col items-center justify-start gap-3 lg:items-start">
              <h5 className="text-center text-lg leading-relaxed font-medium text-orange-600 lg:text-start">
                Transforming Your Team for Success
              </h5>
              <h2 className="font-manrope text-center text-4xl leading-normal font-bold text-gray-900 md:text-5xl md:leading-snug lg:text-start">
                Synergy for Seamless Workflows and Peak Performance
              </h2>
            </div>
            <div className="inline-flex flex-col items-center justify-center gap-8 lg:items-start">
              ...
              <button className="flex w-full items-center justify-center rounded-xl bg-orange-600 px-5 py-2.5 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out hover:bg-orange-700 sm:w-fit">
        ...
        <div className="swiper-container swiper--top pb-10 lg:pb-20">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <img
                className="h-auto w-[309px] object-cover"
                src="https://pagedone.io/asset/uploads/1719467584.png"
              />
            </div>
            <div className="swiper-slide">
              <img
                className="h-auto w-[628px] object-cover"
                src="https://pagedone.io/asset/uploads/1719467595.png"
              />
            </div>
            <div className="swiper-slide">
              <img
                className="h-auto w-[305px] object-cover"
