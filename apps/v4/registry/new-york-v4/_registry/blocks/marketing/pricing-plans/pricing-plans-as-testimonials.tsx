      ...
      <div className="tabs mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid w-full items-center justify-center gap-8 lg:flex lg:justify-between lg:gap-32">
          ...
          <div className="flex items-center justify-center gap-3 lg:justify-start">
            <a
              className="tablink active tablink active inline-block items-center justify-center rounded-full bg-blue-500 px-7 py-3 text-base font-semibold whitespace-nowrap text-white shadow transition-all duration-700 ease-in-out hover:bg-blue-800"
            ...
            <a
              className="tablink inline-block items-center justify-center rounded-full bg-blue-300 px-7 py-3 text-base font-semibold whitespace-nowrap text-white shadow transition-all duration-700 ease-in-out hover:bg-blue-500"
          ...
          <div className="relative flex items-center">
            ...
            <div className="swiper mySwiper">
                ...
                <div className="swiper-slide">
                  <div className="mx-auto flex w-full max-w-xl flex-col justify-between gap-10 rounded-3xl border border-blue-500 p-6 lg:max-w-3xl lg:flex-row lg:gap-12 lg:p-12 lg:px-12 lg:py-12 xl:max-w-4xl">
                    <div className="grid w-full gap-8">
                      <div className="group flex w-full items-center justify-between rounded-xl border border-blue-500 bg-white p-4 hover:cursor-pointer hover:bg-blue-500">
                        <div className="flex items-center justify-start gap-6">
                          ...
                          <div className="inline-flex flex-col items-start justify-start gap-1">
                            ...
                            <div className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-blue-500 px-2 py-1 transition-all duration-700 ease-in-out group-hover:bg-white">
                      ...
                      <div className="group flex w-full items-center justify-between rounded-xl border border-blue-500 bg-white p-4 transition-all duration-700 ease-in-out hover:cursor-pointer hover:bg-blue-500">
              ...
              <button
                ...
                className="swiper-button-prev group hidden h-16 w-16 items-center justify-center rounded-full border border-solid border-blue-500 transition-all duration-500 hover:bg-blue-500 lg:flex"
                data-carousel-prev
              >
                {/* SVG removed */}
              </button>
              <button
                ...
                className="swiper-button-next group hidden h-16 w-16 items-center justify-center rounded-full border border-solid border-blue-500 transition-all duration-500 hover:bg-blue-500 lg:flex"
                data-carousel-next
              >
                {/* SVG removed */}
              </button>
                ...
                <div className="swiper-slide">
                  <div className="mx-auto flex w-full max-w-xl flex-col justify-between gap-10 rounded-3xl border border-blue-500 p-6 lg:max-w-3xl lg:flex-row lg:gap-12 lg:p-12 lg:px-12 lg:py-12 xl:max-w-4xl">
                    <div className="grid w-full gap-8">
                      ...
                      <div className="group flex w-full items-center justify-between rounded-xl border border-blue-500 bg-white p-4 transition-all duration-700 ease-in-out hover:bg-blue-500">
                        <div className="group flex items-center justify-start gap-6">
                          {/* SVG removed */}
                          {/* SVG removed */}
                          <div className="inline-flex flex-col items-start justify-start gap-1">
