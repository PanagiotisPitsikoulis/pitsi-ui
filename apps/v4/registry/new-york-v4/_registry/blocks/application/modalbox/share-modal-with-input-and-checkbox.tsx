                    ...
                    <div className="mb-2.5 flex items-center gap-4">
                      <div className="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          className="mr-2 h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-500 checked:border-blue-500 checked:bg-blue-500 checked:bg-center checked:bg-no-repeat hover:border-blue-500 hover:bg-blue-500"
                          defaultChecked
                        />
                        <label
