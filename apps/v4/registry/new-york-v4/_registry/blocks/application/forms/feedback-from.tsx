                  ...
                  <div className="flex w-full flex-col items-start justify-start gap-3.5">
                    ...
                    <div className="inline-flex w-full items-start justify-between">
                      <a className="group inline-flex w-full flex-col items-center justify-start gap-3.5">
                        <div className="inline-flex items-center justify-center gap-2.5 rounded-full bg-blue-50 p-4 transition-all duration-700 ease-in-out group-hover:bg-blue-500">
                          <img
