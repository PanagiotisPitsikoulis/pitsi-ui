...
export const fancyButtonVariants = tv({
  slots: {
    root: [
      ...
      "focus:outline-none",
      // disabled
      "disabled:pointer-events-none disabled:text-strength-100",
      "disabled:bg-background-elevation-1 disabled:bg-none disabled:shadow-none disabled:before:hidden disabled:after:hidden",
    ],
  ...
  variants: {
    variant: {
      neutral: {
        root: "bg-background-elevation-5 text-static-white dark:text-static-black shadow-fancy-buttons-neutral",
      },
      primary: {
      ...
      basic: {
        root: [
          // base
          "bg-background-elevation-0 text-strength-600 shadow-fancy-buttons-stroke",
          // hover
          "hover:bg-background-elevation-1 hover:text-strength-900 hover:shadow-none",
        ],
      },
    },
    size: {
