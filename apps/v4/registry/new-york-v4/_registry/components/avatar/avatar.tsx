...
export const avatarVariants = tv({
  ...
  variants: {
    ...
    color: {
      gray: {
        root: "bg-[var(--bg-elevation-2)] text-static-black",
      },
      yellow: {
...
export const avatarStatusVariants = tv({
  base: "box-content size-3 rounded-full border-4 border-[var(--bg-elevation-0)]",
  variants: {
    status: {
...
export type AvatarBrandLogoProps = React.ImgHTMLAttributes<HTMLImageElement> & {
  asChild?: boolean
}
...
>(({ asChild, className, ...rest }, forwardedRef) => {
  ...
  return (
    <Component
      ref={forwardedRef}
      className={cn(
        "box-content size-6 rounded-full border-2 border-[var(--bg-elevation-0)]",
        className
      )}
      {...rest}
    />
...
function AvatarNotification({
  ...
  return (
    <div
      className={cn(
        "bg-error-base box-content size-3 rounded-full border-2 border-[var(--bg-elevation-0)]",
        className
      )}
      {...rest}
    />
...
export type AvatarEmptyIconsProps = React.SVGProps<SVGSVGElement>
