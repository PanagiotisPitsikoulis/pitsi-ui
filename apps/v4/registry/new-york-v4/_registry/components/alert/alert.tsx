...
import { tv, type ClassValue, type VariantProps } from "@/lib/ui/tv"
...
export const alertVariants = tv({
  ...
  variants: {
    variant: {
      ...
      light: {
        root: "text-text-strength-900",
        closeIcon: "text-text-strength-900 opacity-40",
      },
      lighter: {
        root: "text-text-strength-900",
        closeIcon: "text-text-strength-900 opacity-40",
      ...
      stroke: {
        root: "bg-background-elevation-0 text-text-strength-900 shadow-regular-md ring-1 ring-inset ring-border-elevation-1",
        closeIcon: "text-text-strength-900 opacity-40",
      },
    },
    status: {
...
export { AlertRoot as Alert, AlertIcon, AlertCloseIcon }
