...
export const buttonGroupVariants = tv({
  slots: {
    ...
    item: [
      // base
      "group relative flex items-center justify-center whitespace-nowrap bg-background-elevation-0 text-center text-text-strength-600 outline-none",
      "border border-border-elevation-1",
      "transition duration-200 ease-out",
      // hover
      "hover:bg-background-elevation-1",
      // focus
      "focus:bg-background-elevation-1 focus:outline-none",
      // active
      "data-[state=on]:bg-background-elevation-1",
      "data-[state=on]:text-text-strength-900",
      // disabled
      "disabled:pointer-events-none disabled:bg-background-elevation-1",
      "disabled:text-text-strength-100",
    ],
    icon: "shrink-0",
  },
  variants: {
...
export type ButtonGroupRootProps = VariantProps<typeof buttonGroupVariants> &
...
export { ButtonGroupRoot as ButtonGroup, ButtonGroupItem, ButtonGroupIcon }
