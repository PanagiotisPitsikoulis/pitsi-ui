...
export const buttonVariants = tv({
  slots: {
    root: [
      ...
      "focus:outline-none",
      // disabled
      "disabled:pointer-events-none disabled:bg-background-elevation-1 disabled:text-text-strength-100 disabled:ring-transparent",
    ],
    icon: [
      // base
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-background-elevation-0 text-primary-base ring-primary-base",
          // hover
    ...
    },
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-background-elevation-0 hover:ring-primary-base",
          // focus
          "focus-visible:bg-background-elevation-0 focus-visible:shadow-button-primary-focus focus-visible:ring-primary-base",
        ],
      },
    },
    {
    ...
    //#region variant=neutral
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-background-elevation-4",
          // focus
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-background-elevation-0 text-text-strength-600 ring-border-elevation-0",
          // hover
          "hover:text-text-strength-900",
          // focus
          "focus-visible:text-text-strength-900 focus-visible:shadow-button-important-focus focus-visible:ring-border-elevation-4",
        ],
      },
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-background-elevation-1 text-text-strength-600 ring-transparent",
          // hover
          "hover:bg-background-elevation-0 hover:text-text-strength-900 hover:shadow-regular-xs hover:ring-border-elevation-1",
          // focus
          "focus-visible:bg-background-elevation-0 focus-visible:text-text-strength-900 focus-visible:shadow-button-important-focus focus-visible:ring-border-elevation-4",
        ],
      },
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-transparent text-text-strength-600 ring-transparent",
          // hover
          "hover:bg-background-elevation-1 hover:text-text-strength-900",
          // focus
          "focus-visible:bg-background-elevation-0 focus-visible:text-text-strength-900 focus-visible:shadow-button-important-focus focus-visible:ring-border-elevation-4",
        ],
      },
    ...
    },
    {
      ...
      class: {
        root: [
          // base
          "bg-background-elevation-0 text-error-base ring-error-base",
          // hover
    ...
    },
    {
      ...
      class: {
        root: [
          ...
          // hover
          "hover:bg-background-elevation-0 hover:ring-error-base",
          // focus
          "focus-visible:bg-background-elevation-0 focus-visible:shadow-button-error-focus focus-visible:ring-error-base",
        ],
      },
    },
    {
...
export { ButtonRoot as Button, ButtonIcon }
