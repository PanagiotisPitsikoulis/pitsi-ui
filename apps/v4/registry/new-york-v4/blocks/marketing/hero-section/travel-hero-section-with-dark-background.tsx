export default function TravelHeroSectionWithDarkBackground() {
  return (
    <div className="h-screen w-full bg-[url('https://pagedone.io/asset/uploads/1720681030.png')] bg-cover bg-center bg-no-repeat">
            ...
            >
              <ul className="mt-4 flex flex-col gap-6 max-lg:mb-4 lg:mt-0 lg:flex-row lg:items-center">
                <li className="px-1.5">
                  <a
                    href="javascript:;"
                    className="block text-base font-medium text-white transition-all duration-500 hover:text-gray-200 lg:px-1.5 lg:text-left"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative px-1.5">
                  <button
                    ...
                    className="dropdown-toggle mr-auto flex items-center justify-between text-base font-medium text-white transition-all duration-500 hover:text-gray-200 lg:m-0 lg:text-left"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
                ...
                <li className="relative px-1.5">
                  <div className="dropdown relative inline-flex">
                    <button
                      ...
                      className="dropdown-toggle mr-auto flex items-center justify-between text-center text-base font-medium text-white transition-all duration-500 hover:text-gray-200 max-lg:h-max lg:m-0 lg:text-left"
                    >
                      Features
                      {/* SVG removed */}
                    </button>
              ...
              <div className="flex flex-col justify-start gap-5 lg:flex-1 lg:flex-row lg:items-center lg:justify-end">
                ...
                <button className="rounded-lg bg-white px-3.5 py-2 text-center shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-500 hover:bg-gray-100">
                  <span className="px-1.5 text-sm leading-6 font-medium text-black">
                    Login
                  </span>
                </button>
                <button className="rounded-lg bg-orange-600 px-3.5 py-2 text-center shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-500 hover:bg-orange-700">
      ...
      <section className="w-full lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="inline-flex w-full flex-col items-start justify-start gap-10 pt-8 pb-24 lg:gap-14 lg:pt-20 lg:pb-36">
            <div className="flex w-full flex-col items-center justify-start gap-8 lg:items-start lg:gap-10">
              <div className="flex flex-col items-start justify-center gap-2.5 rounded-full border border-white py-1 pr-1 pl-[18px]">
                <div className="inline-flex items-center justify-start gap-4">
                  <span className="text-xs leading-normal font-medium text-white">
                    Secrets of the jungle{" "}
                  </span>
                  <a className="flex h-[34px] w-[34px] items-center justify-center rounded-full bg-white shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out hover:bg-gray-100">
                    {/* SVG removed */}
                  </a>
                </div>
              </div>
              <div className="flex w-full flex-col items-center justify-start gap-5 lg:items-start">
                <h2 className="font-manrope w-full text-center text-6xl leading-normal font-bold text-orange-600 md:text-7xl md:leading-snug lg:max-w-xl lg:text-start">
                  Safety
                  <span className="text-white"> Tips for Jungle Travel</span>
                </h2>
                <p className="w-full text-center text-lg leading-relaxed font-normal text-white lg:max-w-xl lg:text-start">
            ...
            <button className="mx-auto flex w-full items-center justify-center rounded-full bg-orange-600 px-5 py-2.5 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out hover:bg-orange-700 sm:w-fit lg:ml-0">
