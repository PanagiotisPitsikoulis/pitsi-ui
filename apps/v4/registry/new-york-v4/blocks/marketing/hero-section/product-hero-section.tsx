export default function ProductHeroSection() {
  return (
    <div>
      <nav className="top-0 left-0 z-50 w-full border-b border-gray-300 bg-white py-5 transition-all duration-500 lg:fixed">
    ...
    https://pagedone.io/"
      ...
      <section className="relative py-14 lg:pt-36 lg:pb-14">
        <div className="mx-auto w-full max-w-7xl px-4 lg:px-8">
          <div className="mx-auto grid max-w-md grid-cols-12 gap-8 md:max-w-3xl lg:max-w-full">
            <a
              href="javascript:;"
              className="group col-span-12 overflow-hidden lg:col-span-8"
            >
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://pagedone.io/asset/uploads/1710221308.png"
                  alt="men with t-shirt"
                  className="relative z-0 h-full w-full rounded-2xl object-cover transition-all duration-700 group-hover:scale-110"
                />
                <div className="absolute top-0 left-0 z-10 flex h-full w-full items-start p-8">
                  <div className="block">
                    <h4 className="font-manrope mb-2.5 text-4xl font-medium text-white md:text-5xl md:leading-relaxed">
                      The Essential <br />
                      Smart <br />
                      Watch
                    </h4>
                    <p className="w-48 max-w-xs text-base font-normal text-white md:w-full">
                      The perfect fusion of style and functionality, designed to
                      seamlessly integrate into your daily life.
                    </p>
                  </div>
                </div>
              </div>
            </a>
            <div className="col-span-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:col-span-4 lg:grid-cols-1">
              <div className="group relative overflow-hidden rounded-2xl">
                <img
                  src="https://pagedone.io/asset/uploads/1710221321.png"
                  alt="men with t-shirt"
                  className="relative z-0 h-full w-full rounded-2xl object-cover"
                />
                <div className="absolute top-0 left-0 z-10 flex h-full w-full flex-col justify-between p-8">
                  <h4 className="font-manrope mb-1.5 text-4xl leading-snug font-semibold text-white">
                    JBL Tune <br />
                    760NC
                  </h4>
                  <button className="flex h-16 w-16 items-center justify-center rounded-full border border-white bg-transparent text-xl leading-8 font-normal text-white transition-all duration-500 group-hover:rotate-45 hover:bg-white hover:text-gray-900">
                    {/* SVG removed */}
                  </button>
                </div>
              </div>
              <div className="group relative rounded-2xl">
                <img
                  src="https://pagedone.io/asset/uploads/1710221333.png"
                  alt="men with t-shirt"
                  className="relative z-0 h-full w-full rounded-2xl object-cover"
                />
                <div className="absolute top-0 left-0 z-10 flex h-full w-full flex-col justify-between p-8">
                  <h4 className="font-manrope mb-1.5 text-4xl leading-snug font-semibold text-black">
                    Sony SRS-XB100 <br />
                    Speakers
                  </h4>
                  <button className="flex h-16 w-16 items-center justify-center rounded-full border border-black bg-transparent text-xl leading-8 font-normal text-black transition-all duration-500 group-hover:rotate-45 hover:bg-black hover:text-white">
                    {/* SVG removed */}
                  </button>
                </div>
              </div>
