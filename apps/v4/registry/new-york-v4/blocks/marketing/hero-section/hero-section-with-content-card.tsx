export default function HeroSectionWithContentCard() {
  return (
    <div>
        ...
        https://pagedone.io/"
            ...
            >
              ...
              <div className="flex w-full flex-col justify-start gap-5 max-lg:gap-5 lg:ml-14 lg:w-max lg:flex-row lg:items-center lg:justify-end">
                <button className="flex cursor-pointer items-center justify-center rounded-lg bg-yellow-400 px-3.5 py-2 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 hover:bg-yellow-500">
                  {/* SVG removed */}
      ...
      <section className="w-full pt-10 pb-14 lg:pt-[124px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="inline-flex w-full flex-col items-center justify-start gap-5">
            <div className="grid w-full grid-cols-1 items-start justify-center gap-5 lg:grid-cols-12">
              <div className="col-span-12 inline-flex h-full flex-col items-start justify-center gap-11 rounded-xl bg-lime-200 p-6 md:p-10 lg:col-span-8">
                <div className="flex flex-col items-start justify-start gap-3">
                  <h6 className="text-base leading-relaxed font-normal text-gray-700">
                    Fitness for a Better You
                  </h6>
                  <h2 className="font-manrope text-5xl leading-tight font-semibold text-gray-900">
                    Achieve Your Fitness Goals with Our Expert Guidance
                  </h2>
                </div>
                <button className="flex items-center justify-center rounded-xl bg-gray-900 px-5 py-2.5 transition-all duration-700 ease-in-out hover:bg-gray-700">
                  <span className="px-2 py-px text-base leading-relaxed font-semibold text-gray-50">
                    Get Started
                  </span>
                </button>
              </div>
              <img
                className="col-span-12 h-[474px] w-full rounded-xl object-cover lg:col-span-4 lg:h-full"
                src="https://pagedone.io/asset/uploads/1719209297.png"
              />
            </div>
            <div className="grid grid-cols-1 items-start justify-start gap-5 lg:grid-cols-12">
              <div className="col-span-12 flex h-full flex-col items-center justify-start gap-5 rounded-xl bg-blue-100 p-6 md:flex-row md:p-8 lg:col-span-7">
                <img
                  className="h-[200px] w-full rounded-lg object-cover md:h-auto md:w-auto"
                ...
                <div className="inline-flex flex-col items-start justify-center gap-2">
                  ...
                  <p className="max-w-5xl text-lg leading-relaxed font-medium text-gray-500">
              ...
              <div className="col-span-12 inline-flex h-full flex-col items-start justify-start gap-4 rounded-xl bg-gray-100 p-6 md:p-8 lg:col-span-5">
                <div className="flex flex-col items-start justify-start gap-1">
                  <div className="inline-flex items-center justify-start gap-2.5">
                    <h3 className="font-manrope text-3xl leading-normal font-extrabold text-gray-900">
                      80K+
                    </h3>
