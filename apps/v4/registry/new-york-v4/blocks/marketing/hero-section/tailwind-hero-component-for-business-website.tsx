          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 xl:gap-28">
            <div className="block max-lg:order-last">
              <img
                ...
                className="h-auto rounded-3xl object-cover max-lg:mx-auto lg:w-full"
              />
            </div>
            <div className="mx-auto flex w-full items-center max-lg:max-w-xl">
              <div className="block">
                <h1 className="font-manrope mb-7 text-5xl leading-[1.2] font-extrabold text-gray-900 max-[450px]:text-center">
                  Accelerate Your Transactions with{" "}
                  <span className="text-indigo-600">Seamless Efficiency</span>
                </h1>
                <p className="mb-7 text-base font-medium text-gray-500 max-[450px]:text-center">
                ...
                <div className="mb-14 flex flex-col items-center gap-5 min-[450px]:flex-row xl:mb-24">
                  <button className="flex items-center gap-2 rounded-lg bg-indigo-600 py-2.5 pr-5 pl-7 text-base font-semibold text-white transition-all duration-500 hover:bg-indigo-700 max-[450px]:w-full max-[450px]:justify-center">
                    Get started
                    {/* SVG removed */}
                  </button>
                  <button className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white py-2.5 pr-5 pl-7 text-base font-semibold text-indigo-600 shadow-sm shadow-transparent transition-all duration-500 hover:border-indigo-100 hover:bg-indigo-100 hover:shadow-gray-300 max-[450px]:w-full max-[450px]:justify-center">
                    See Demo
                    {/* SVG removed */}
                  </button>
                </div>
                <div className="flex flex-col items-center gap-8 min-[450px]:flex-row min-[450px]:gap-28">
                  <div className="block">
                    <h4 className="font-manrope mb-2 text-2xl leading-9 font-extrabold text-indigo-600 max-[450px]:text-center">
                      850K+
                    </h4>
                    <p className="text-base font-normal text-gray-500 max-[450px]:text-center">
                      Satisfied users
                    </p>
                  </div>
                  <div className="block">
