    ...
    <div>
      <nav className="z-50 w-full bg-white pt-6 pb-5 transition-all duration-500 lg:fixed">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-4 2xl:px-0">
          <div className="flex w-full flex-col rounded-2xl bg-indigo-50 px-8 py-3 lg:flex-row lg:rounded-full">
        ...
        https://pagedone.io/"
            ...
            >
              ...
              <div className="flex w-full flex-col justify-start gap-5 lg:ml-14 lg:w-max lg:flex-row lg:items-center lg:justify-end">
                <button className="flex cursor-pointer items-center justify-center rounded-full bg-indigo-100 px-3.5 py-2 transition-all duration-700 hover:bg-indigo-200">
                  <span className="px-1.5 text-sm leading-6 font-medium text-indigo-600">
                    Login
                  </span>
                </button>
                <button className="flex cursor-pointer items-center justify-center rounded-full bg-indigo-600 px-3.5 py-2 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 hover:bg-indigo-800">
      ...
      <section className="lg:pt-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-4 2xl:px-0">
          <div className="flex w-full flex-col items-center justify-center gap-10 py-8 md:py-10 lg:flex-row lg:gap-12 lg:py-14 xl:gap-24">
            <div className="inline-flex flex-col items-start justify-start gap-20">
              <div className="flex flex-col items-start justify-start gap-10">
                <div className="flex flex-col items-center justify-start gap-8 lg:items-start">
                  <h2 className="font-manrope w-full text-center text-5xl leading-tight font-semibold text-black lg:max-w-xl lg:text-start">
                    Journey Towards Embarking on the Path of Creation explores
                  </h2>
                  <p className="w-full text-center text-lg leading-relaxed font-normal text-gray-500 lg:max-w-2xl lg:text-start">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-3 sm:flex-row lg:items-start lg:justify-start">
                  ...
                  <button className="flex w-full items-center justify-center rounded-full bg-indigo-100 px-3.5 py-2 transition-all duration-700 ease-in-out hover:bg-indigo-200 sm:w-fit">
                    <span className="px-1.5 text-sm leading-6 font-medium text-indigo-700">
                      Learn more
                    </span>
                  </button>
                </div>
