export default function VerticalHeroSectionWithVideo() {
  return (
    <div className="bg-gray-50">
      <nav className="w-full border-b border-solid border-gray-200 bg-white py-5 transition-all duration-500">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex w-full flex-col lg:flex-row">
            ...
            <div
              className="hidden w-full max-lg:h-screen max-lg:overflow-auto max-lg:pb-8 lg:flex lg:pl-11"
              id="navbar"
            >
              <ul className="ml-auto flex flex-col max-lg:gap-4 max-lg:py-6 lg:mt-0 lg:flex-row lg:items-center">
                <li>
                  <a
                    href="javascript:;"
                    className="block text-base font-medium text-gray-500 transition-all duration-500 hover:text-gray-900 md:mb-0 lg:mr-6 lg:text-left"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle hover:text-prime-blue-700 mr-auto flex items-center justify-between text-center text-base font-medium text-gray-500 transition-all duration-500 lg:m-0 lg:mr-6 lg:mb-0 lg:text-left"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
      ...
      <section className="relative overflow-hidden py-5 before:absolute before:bottom-0 before:h-28 before:w-full before:bg-indigo-600 before:content-[''] lg:py-20 lg:before:h-2/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-24 grid grid-cols-1 items-center gap-4 lg:grid-cols-12 lg:gap-6 xl:gap-24">
            <div className="w-full pb-12 md:order-first lg:col-span-6 lg:pb-0">
              <div className="text-center lg:max-w-xl lg:text-left">
                <span className="mr-auto mb-2 ml-auto flex h-7 w-40 items-center justify-center rounded-full bg-white px-2 text-sm font-medium text-indigo-500 lg:mr-0 lg:ml-0">
                  {/* SVG removed */}
                  Finance organized
                </span>
                <h1 className="font-manrope pb-5 text-center text-5xl leading-[50px] font-extrabold text-gray-900 lg:text-left">
                  Get <span className="text-indigo-600">Expert Advice</span> on
                  financial journey.
                </h1>
                <div className="flex flex-col justify-center gap-5 md:flex-row lg:justify-start">
                  <a
                    href="javascript:;"
                    className="flex h-11 items-center justify-center rounded-full bg-indigo-600 px-6 py-2 text-sm font-semibold text-white transition-all duration-500 hover:bg-indigo-700 focus:outline-none"
                  >
                    Connect us
                  </a>
                  <a
                    href="javascript:;"
                    className="flex items-center justify-center gap-2 rounded-full py-2 pr-4 pl-6 text-base font-semibold text-indigo-600 transition-all duration-500 hover:bg-indigo-50 focus:outline-none"
                  >
                    View more
                    {/* SVG removed */}
                  </a>
            ...
            <div className="w-full lg:col-span-6">
              <p className="text-center text-lg font-normal text-gray-500 lg:text-left">
          ...
          <div className="relative">
            ...
            />
            <button className="bg-opacity-10 absolute top-0 right-0 bottom-0 left-0 m-auto flex h-14 w-14 items-center justify-center rounded-full border border-solid border-white bg-white backdrop-blur-sm md:h-20 md:w-20 lg:h-28 lg:w-28">
              {/* SVG removed */}
            </button>
          </div>
        </div>
