export default function HeroSectionWithGradientBackground() {
  return (
    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex w-full flex-col lg:flex-row">
            ...
            <div className="hidden w-full lg:flex lg:pl-11" id="navbar">
              <ul className="mt-4 flex flex-col max-lg:gap-4 max-lg:pb-4 lg:mt-0 lg:flex-row lg:items-center">
                <li>
                  <a
                    href="javascript:;"
                ...
                <li className="relative">
                  ...
                  <div
                    ...
                    className="animate-fade relative top-3 z-10 hidden min-w-full rounded-lg bg-white p-2 shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] max-lg:mb-2 md:min-w-[500px] lg:absolute lg:top-14 lg:-left-80 lg:min-w-[800px] lg:p-4 xl:p-8"
                  >
                ...
                <li className="relative">
                  ...
                  <div
                    ...
                    className="dropdown-menu relative top-3 z-10 hidden w-64 rounded-lg bg-white p-2 font-normal shadow-lg shadow-gray-200 max-lg:mb-2 lg:absolute lg:top-14 lg:p-4 xl:p-8"
                  >
                    <ul
      ...
      <section className="relative overflow-x-hidden py-5 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full pb-12 md:order-first lg:col-span-6 lg:pb-0">
              <div className="text-center lg:max-w-xl lg:text-left">
                ...
                <div className="flex flex-col justify-center gap-5 md:flex-row lg:justify-start">
                  <a
                    href="javascript:;"
                    className="flex items-center justify-center rounded-full bg-indigo-600 px-7 py-4 text-base font-semibold text-white transition-all duration-500 hover:bg-indigo-700 focus:outline-none"
                  >
                    Purchase now
                  </a>
                  <a
                    href="javascript:;"
                    className="flex h-14 w-full items-center justify-center rounded-full bg-indigo-50 text-base font-semibold text-indigo-600 transition-all duration-500 hover:bg-indigo-100 focus:outline-none md:w-14"
                  >
                    {/* SVG removed */}
                  </a>
                </div>
            ...
            <div className="w-full lg:col-span-6">
              <div className="relative flex justify-center">
                <img
                  ...
                  className="w-2/3 rounded-3xl object-cover lg:w-4/5 xl:w-auto"
                />
                <img
                  src="https://pagedone.io/asset/uploads/1694847404.png"
                  alt="John Doe Card image"
                  className="absolute -right-2 w-4/5 object-cover lg:-right-16 lg:w-11/12 xl:-right-24 xl:w-auto"
                />
                <img
                  src="https://pagedone.io/asset/uploads/1694847419.png"
                  alt="John Doe Card image"
                  className="absolute -bottom-5 -left-2 w-4/5 object-cover lg:-left-16 lg:w-11/12 xl:-left-24 xl:w-auto"
                />
              </div>
            </div>
          </div>
