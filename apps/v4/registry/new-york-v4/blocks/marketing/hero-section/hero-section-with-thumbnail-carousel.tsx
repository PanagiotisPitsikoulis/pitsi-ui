export default function HeroSectionWithThumbnailCarousel() {
  return (
    <div className="w-full bg-[url('https://pagedone.io/asset/uploads/1719567529.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex w-full flex-col lg:flex-row">
            ...
            <div
              ...
              id="navbar"
            >
              <ul className="flex flex-col gap-6 max-lg:mb-4 max-lg:pt-4 lg:mt-0 lg:ml-auto lg:flex-row lg:items-center lg:justify-center">
                <li>
                  <a
                    href="javascript:;"
      ...
      <section className="w-full pb-12 lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="swiper-container slider inline-flex w-full flex-col items-start justify-start gap-12 pt-10 md:gap-24 lg:pt-28">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="flex w-full flex-col items-start justify-start gap-8">
                  <div className="flex flex-col">
                    <h2 className="font-playfairDisplay text-6xl leading-snug font-normal text-white md:text-7xl md:leading-normal xl:text-[90px] xl:leading-snug">
                      A Journey of{" "}
                    </h2>
                    <h2 className="font-playfairDisplay text-6xl leading-snug font-normal text-white md:text-7xl md:leading-normal xl:text-[90px] xl:leading-snug">
                  ...
                  <p className="w-full pb-14 text-base leading-relaxed font-medium text-gray-300 md:pb-28 lg:max-w-xl">
          ...
          <div className="swiper-container slider-thumbnail relative">
            <div className="swiper-wrapper flex-col lg:flex-row">
              <div className="swiper-slide">
                <div className="text-lg leading-relaxed font-normal whitespace-nowrap text-white">
