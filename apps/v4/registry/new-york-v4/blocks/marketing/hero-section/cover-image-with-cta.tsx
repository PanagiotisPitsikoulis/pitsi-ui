  ...
  return (
    <div>
      ...
      <section className="lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="inline-flex w-full flex-col items-start justify-start gap-10 py-10 lg:gap-16 lg:py-14">
            <div className="flex w-full flex-col items-center justify-start gap-7 lg:gap-9">
              <div className="flex w-full flex-col items-center justify-start gap-5">
                <h2 className="font-manrope w-full text-center text-5xl leading-tight font-bold text-gray-900 md:text-5xl md:leading-snug lg:max-w-3xl">
