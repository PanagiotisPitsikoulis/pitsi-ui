  ...
  return (
    <div>
              ...
              <ul className="mt-4 flex flex-col gap-6 max-lg:mb-4 lg:mt-0 lg:flex-row lg:items-center">
                ...
                <li className="relative px-1.5">
                  <button
                    ...
                    className="dropdown-toggle mr-auto flex items-center justify-between text-base font-medium text-gray-500 transition-all duration-500 hover:text-indigo-700 lg:m-0 lg:text-left"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
                ...
                <li className="relative px-1.5">
                  <div className="dropdown relative inline-flex">
                    <button
                      ...
                      className="dropdown-toggle mr-auto flex items-center justify-between text-center text-base font-medium text-gray-500 transition-all duration-500 hover:text-indigo-700 max-lg:h-max lg:m-0 lg:text-left"
                    >
                      Features
                      {/* SVG removed */}
                    </button>
      ...
      <section className="w-full lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex w-full flex-col items-start justify-start gap-10 py-10 lg:gap-14 lg:py-14">
            <div className="grid w-full grid-cols-1 items-start justify-start gap-8 lg:grid-cols-2 lg:gap-16">
              <h2 className="font-playfairDisplay text-center text-5xl leading-snug font-semibold text-gray-900 lg:text-start">
                Elevate Your Style with Our Affordable Bag Collection.
              </h2>
              <div className="inline-flex flex-col items-center justify-start gap-8 lg:items-start">
                ...
                <button className="group flex items-center justify-center gap-3 rounded-full border border-indigo-600 py-2 pr-2 pl-4 text-center transition-all duration-700 ease-in-out hover:border-indigo-800">
                  <span className="text-center text-sm leading-tight font-semibold text-indigo-600">
                    Get Started
                  </span>
                  <div className="flex h-[34px] w-[34px] items-center justify-center rounded-full bg-indigo-600 transition-all duration-700 ease-in-out group-hover:bg-indigo-800">
                    {/* SVG removed */}
                  </div>
                </button>
              </div>
            </div>
            <div className="grid w-full items-start justify-start gap-6 lg:grid-cols-3 xl:gap-8">
              <div className="flex h-full w-full grid-rows-2 flex-col items-start justify-start gap-6 lg:grid xl:gap-8">
                <div className="flex h-full w-full flex-col items-start justify-start gap-2.5 rounded-3xl bg-indigo-600 p-6 lg:rounded-xl">
                ...
                <img
                  className="h-auto w-full rounded-3xl object-cover lg:h-full lg:rounded-xl"
                  src="https://pagedone.io/asset/uploads/1719399636.png"
                />
              </div>
              <img
                className="h-auto w-full rounded-3xl object-cover lg:h-full lg:rounded-2xl"
                src="https://pagedone.io/asset/uploads/1719399646.png"
              />
              <div className="grid h-full w-full grid-rows-2 flex-col items-start justify-start gap-6 xl:gap-8">
                <img
                  className="h-auto w-full rounded-3xl object-cover lg:h-full lg:rounded-2xl"
                  src="https://pagedone.io/asset/uploads/1719399655.png"
                />
                <div className="flex h-auto w-full flex-col items-start justify-start gap-2.5 rounded-3xl bg-indigo-600 p-6 lg:h-full lg:rounded-2xl">
