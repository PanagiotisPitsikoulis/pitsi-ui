export default function TeamSectionCardWithBackgroundColor() {
  return (
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="hidden w-full flex-col items-center justify-center gap-2.5 bg-blue-500 px-16 py-24 md:flex md:py-0 lg:hidden">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-2.5 bg-blue-500 px-16 py-24 md:hidden md:py-0 lg:flex">
            <div className="flex flex-col items-center justify-start gap-2.5">
              <div className="flex flex-col items-center justify-start gap-1">
                <h4 className="font-manrope text-center text-2xl leading-9 font-semibold text-white">
                  Dianne Russell
