    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 sm:gap-6 lg:grid lg:grid-cols-3 lg:items-center lg:space-y-0 xl:gap-8">
          {/*Pricing Card*/}
          <div className="group mx-auto w-full max-w-sm rounded-3xl bg-gray-50 p-6 transition-all duration-500 hover:bg-indigo-600 lg:max-w-full xl:p-8">
            ...
            {/*List*/}
            <ul className="mb-9 space-y-6 text-left text-gray-800 group-hover:text-white">
            ...
            <a
              href="javascript:;"
              className="block w-full rounded-full border border-gray-300 bg-transparent px-7 py-3 text-center text-base font-semibold text-black transition-all duration-500 group-hover:bg-white group-hover:text-indigo-600"
            >
              Select Plan
            </a>
            {/*List End*/}
