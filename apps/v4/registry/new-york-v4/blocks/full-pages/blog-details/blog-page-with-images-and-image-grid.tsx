export default function BlogPageWithImagesAndImageGrid() {
  return (
    <div>
      <nav className="relative top-0 left-0 z-[99999] w-full border-b border-indigo-300 py-5 transition-all duration-500">
            ...
            <div className="flex w-full items-center justify-between pl-10">
              <ul className="mt-4 hidden flex-col items-center lg:mt-0 lg:flex lg:flex-row">
                <li>
                  <a
                    href="javascript:;"
                    className="mb-2 block text-center text-sm font-medium text-gray-900 transition-all duration-500 hover:text-indigo-600 md:mb-0 lg:mr-6 lg:text-left lg:text-base"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    ...
                    className="m-auto mr-auto mb-2 flex items-center justify-between text-center text-sm font-medium text-gray-900 transition-all duration-500 hover:text-indigo-600 lg:m-0 lg:mr-6 lg:mb-0 lg:text-left lg:text-base"
                  >
                    Products
                  </button>
                  {/* Dropdown menu */}
              ...
              <div className="flex items-center justify-end gap-4 min-[451px]:justify-center">
                ...
                <button className="cursor-pointer rounded-full border border-white bg-indigo-600 px-6 py-3 text-center text-sm font-semibold whitespace-nowrap text-white shadow-xs transition-all duration-500 hover:bg-indigo-700 max-[450px]:hidden">
                  Sign up{" "}
                </button>
              </div>
            </div>
      ...
      <section className="relative pt-14">
        <div className="mx-auto w-full max-w-xl px-4 md:max-w-3xl md:px-2 lg:max-w-5xl">
          <h1 className="font-manrope mb-7 text-4xl leading-snug font-semibold text-black sm:text-5xl">
      ...
      <section className="relative py-16">
        <div className="mx-auto w-full max-w-xl px-4 md:max-w-3xl md:px-2 lg:max-w-5xl">
          <h4 className="font-manrope mb-6 text-2xl leading-9 font-semibold text-black">
            Save up to 40% compared to a merchant cash advance and other online
            lenders.
          </h4>
          <p className="mb-6 text-lg leading-8 font-normal text-gray-600">
      ...
      <section className="relative pb-16">
        <div className="mx-auto w-full max-w-xl px-4 md:max-w-3xl md:px-2 lg:max-w-5xl">
          <div className="head-1 mb-11">
            <h2 className="font-manrope mb-4 text-5xl leading-tight font-semibold text-black">
      ...
      <section className="relative">
        <div className="mx-auto w-full max-w-xl px-4 md:max-w-3xl md:px-2 lg:max-w-5xl">
          ...
          <h5 className="font-manrope mb-6 text-2xl leading-9 font-semibold text-gray-900">
          ...
          <div className="mb-5 flex items-center justify-center"></div>
          <h2 className="font-manrope mb-16 text-center text-3xl leading-snug font-semibold text-gray-900 sm:text-5xl">
      ...
      <section className="relative">
        <div className="mx-auto w-full max-w-xl px-4 md:max-w-3xl md:px-2 lg:max-w-5xl">
          ...
          <div className="reply-box mb-24">
            <p className="mb-5 text-xl leading-8 font-medium text-black">
              Leave a Reply
            </p>
            <form>
              <textarea
                name="comment"
                id=""
                className="mb-5 h-44 w-full resize-none rounded-2xl border border-gray-300 px-4 py-2.5 text-base leading-7 font-normal text-gray-900 placeholder:text-gray-400 focus-within:outline-0"
                placeholder="Comment"
              />
              <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                <div className="relative">
                  <input
                    type="text"
                    id="default-search"
                    className="block h-11 w-full rounded-full border border-gray-300 bg-transparent px-5 py-2.5 text-base font-normal text-gray-900 placeholder-gray-400 shadow-xs focus:outline-none"
                    placeholder="Name"
                    required
                  />
                </div>
              ...
              <button className="rounded-full bg-indigo-600 px-7 py-[14px] text-base font-semibold text-white transition-all duration-500 hover:bg-indigo-700">
                Post Comment{" "}
              </button>
            </form>
          </div>
            ...
            <div className="mb-7 flex w-full flex-col gap-x-9 gap-y-4 sm:flex-row">
              ...
              <div className="data w-full">
                <div className="mb-5 flex w-full items-center justify-between">
                  ...
                  <button className="rounded-full bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-500 hover:bg-indigo-700">
                    Reply
                  </button>
                </div>
