    ...
    <section>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex w-full flex-col items-center justify-start gap-10 pt-12 pb-12 lg:gap-16 lg:pt-[180px] lg:pb-28">
          <div className="flex w-full flex-col items-center justify-start gap-6 md:gap-8 lg:gap-11">
            <div className="flex w-full flex-col items-center justify-start gap-4 md:gap-6">
              <h2 className="font-manrope text-center text-5xl leading-tight font-bold text-indigo-500">
                Oops! Lost in Cyberspace?
              </h2>
              <p className="w-full text-center text-base leading-relaxed font-medium text-gray-600 lg:max-w-2xl">
                we'll help you find your way back. Explore our platform to
                discover the tools and resources you need to stay.
              </p>
            </div>
            <div className="flex w-full flex-col items-center justify-center gap-4 sm:flex-row sm:gap-2.5">
              <input
                type="text"
                className="h-14 w-full rounded-lg border border-gray-300 px-5 py-3 text-lg leading-relaxed font-normal text-gray-900 placeholder-gray-400 shadow-xs focus:outline-none sm:w-96"
                placeholder="Search our site"
              />
              <button className="flex w-full items-center justify-center rounded-xl bg-indigo-500 px-6 py-3 shadow transition-all duration-500 ease-in-out hover:bg-indigo-600 sm:w-fit">
