...
export function AppDatabaseSettings1() {
      ...
      <div className="mx-auto max-w-5xl space-y-4">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-6">
              <Avatar className="size-20">
                <AvatarImage src="/avatars/03.webp" />
                <AvatarFallback className="bg-muted text-xl">SM</AvatarFallback>
              </Avatar>
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setPreferences({ ...preferences, defaultDatabase: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setPreferences({ ...preferences, queryTimeout: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(v) =>
                  setPreferences({ ...preferences, autoSave: v })
                }
              />
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>Query Notifications</Label>
                <p className="text-muted-foreground text-sm">
                  Get notified when long queries complete
                </p>
              </div>
              <Switch
