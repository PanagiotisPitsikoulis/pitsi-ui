export default function CreativeDashboardLayoutTailwind() {
  return (
    <div id="main" className="group relative">
      ...
      <aside
        id="sidemenu"
        className="group absolute z-10 flex min-h-screen flex-shrink-0 -translate-x-full flex-col border-r border-gray-200 bg-white transition-all duration-500 ease-in-out group-[.is-open]:w-64 group-[.is-open]:translate-x-0 max-sm:w-full lg:fixed lg:w-16 lg:translate-x-0 dark:border-gray-800 dark:bg-gray-900"
      >
        {/*Sidebar Header*/}
        <div className="mx-4 flex flex-shrink-0 items-center justify-between gap-4 border-b border-gray-200 py-6 group-[.is-open]:flex-row dark:border-gray-800">
          <a href="#"></a>
          <button
            id="navbar-toggle"
      ...
      >
        <div className="absolute top-0 left-0 -z-10 h-[200px] w-full bg-indigo-50 dark:bg-gray-800" />
        <div className="mx-4 flex items-center justify-between border-b border-gray-200 px-4 py-3.5 dark:border-gray-700">
          <div className="block">
            ...
            <div className="dropdown relative inline-flex">
              ...
              >
                <ul className="flex flex-col gap-2.5 px-3 py-2">
                  ...
                  <li className="flex items-center justify-start gap-1.5">
                    <button className="group flex items-center gap-1.5 rounded-lg border border-solid border-indigo-600 bg-indigo-600 px-2 py-2 text-sm font-medium whitespace-nowrap text-white transition-all duration-300 hover:border-indigo-700 hover:bg-indigo-700 lg:pr-5 lg:pl-3.5"></button>
                    <span className="text-sm font-medium text-gray-700">
                      Add Employee
                    </span>
                  </li>
        ...
        <div className="grid-cols-12 gap-12 p-8 lg:grid">
          <div className="col-span-12 mb-8 lg:col-span-9 lg:mb-0">
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <div className="h-[350px] rounded-xl border border-gray-200 md:h-[400px] lg:h-[700px]">
                <img
          ...
          <div className="col-span-12 mb-8 lg:col-span-3 lg:mb-0">
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <div className="h-[350px] rounded-xl border border-gray-200 md:h-[400px] lg:h-[700px]">
                <img
                  src="https://pagedone.io/asset/uploads/1712309277.png"
