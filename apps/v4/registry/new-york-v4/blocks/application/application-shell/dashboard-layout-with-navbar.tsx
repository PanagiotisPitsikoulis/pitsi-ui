export default function DashboardLayoutWithNavbar() {
  return (
    <div className="relative bg-gray-50 dark:bg-gray-900">
      {/*header*/}
      <nav className="fixed w-full border-b border-transparent px-6 py-3.5 lg:border-gray-200 dark:border-gray-700 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-between gap-1 sm:gap-6 lg:flex-row">
          ...
          <div
            id="mobile-navbar"
            className="hidden w-full flex-1 flex-row rounded-xl bg-white py-4 shadow-sm lg:flex lg:bg-transparent lg:py-0 lg:shadow-none dark:bg-transparent"
          >
      ...
      <div className="pt-[70px]">
        <div className="bg-gray-50 px-3 py-4 lg:px-8 dark:bg-gray-900">
