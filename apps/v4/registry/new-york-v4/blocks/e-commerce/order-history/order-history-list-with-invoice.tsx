        ...
        <div className="mt-7 border border-gray-300 pt-9">
          <div className="flex items-center justify-between px-3 max-md:flex-col md:px-11">
            ...
            <div className="flex items-center gap-3 max-md:mt-5">
              ...
              <button className="rounded-full bg-indigo-600 px-7 py-3 text-sm font-semibold text-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                Buy Now
              </button>
            </div>
          </div>
