...
// Hero 24 defaults - Boat/Yacht theme (4-column with stat cards)
const hero24Defaults = {
  ...
  image: {
    src: "/elements/subject/boat/6.webp",
...
export function Hero24({ content = {}, classNames = {} }: HeroBlockProps) {
  const {
    ...
    nav = hero24Defaults.nav,
    stats = hero24Defaults.stats,
