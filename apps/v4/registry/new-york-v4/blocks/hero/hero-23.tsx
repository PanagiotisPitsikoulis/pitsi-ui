...
// Hero 23 defaults - Boat/Yacht theme (3-column asymmetric)
const hero23Defaults = {
  ...
  image: {
    src: "/elements/subject/boat/4.webp",
    alt: "Yacht at horizon",
  },
  secondaryImage: {
    src: "/elements/subject/boat/5.webp",
    alt: "Yacht interior",
  },
  nav: {
    logo: "AZURE",
...
export function Hero23({ content = {}, classNames = {} }: HeroBlockProps) {
  const {
    ...
    secondaryImage = hero23Defaults.secondaryImage,
    nav = hero23Defaults.nav,
