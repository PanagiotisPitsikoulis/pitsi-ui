          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-end p-8 lg:p-12">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-foreground font-semibold">Alex Thompson</p>
              ...
              <div className="border-foreground/30 mt-8 grid grid-cols-3 gap-4 border-t pt-8">
                <div>
                  ...
                  <p className="text-foreground/80 mt-1 text-xs">Varieties</p>
                </div>
                <div>
                  <p className="text-foreground text-2xl font-medium lg:text-3xl">
                    Free
                  </p>
                  <p className="text-foreground/80 mt-1 text-xs">Care Guide</p>
                </div>
                <div>
                  <p className="text-foreground text-2xl font-medium lg:text-3xl">
                    Expert
                  </p>
                  <p className="text-foreground/80 mt-1 text-xs">Advice</p>
                </div>
              </div>
            </div>
          </BlockThemeWrapper>
