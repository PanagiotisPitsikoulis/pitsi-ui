...
const cta4Defaults = {
  ...
  description:
    "Join over 10,000 plant enthusiasts who have transformed their spaces with our curated collection. Free care guides included.",
  primaryCta: { label: "Browse Plants", href: "#" },
  secondaryCta: { label: "Get Care Tips", href: "#" },
}
      ...
      >
        <div className="mx-auto max-w-2xl">
          <ScrollScale startScale={0.85} endScale={1}>
            ...
            >
              {/* Icon */}
              <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#84a98c]/10">
                <DynamicIcon name="Leaf" className="h-8 w-8 text-[#84a98c]" />
              </div>
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                {primaryCta && (
                  <Button
                    size="lg"
                    className="group w-full bg-[#52796f] text-white hover:bg-[#344e41] sm:w-auto"
                    asChild
                  >
