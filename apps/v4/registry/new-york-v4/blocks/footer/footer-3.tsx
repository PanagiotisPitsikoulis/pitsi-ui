...
export function Footer3({ content = {}, classNames = {} }: FooterBlockProps) {
  const {
    ...
    navigation = footer3Defaults.navigation,
  ...
  return (
    ...
    >
      <div
        className={cn(
          "container flex flex-col items-center justify-between gap-4 px-6 py-6 md:flex-row",
      ...
      >
        ...
        <Link
          href={logo?.href ?? "#"}
          className={cn("text-lg font-bold", classNames.logo)}
        >
          {logo?.text}
        </Link>
