...
const footer8Defaults = {
  ...
  tagline: "Follow us for the latest updates",
  social: [
    {
  ...
  copyright: "2024 Social. All rights reserved.",
}
    ...
    >
      <div className={cn("container px-6 py-16", classNames.container)}>
        ...
        <div className="mb-12 text-center">
          <Link
            href={logo?.href ?? "#"}
            className={cn("text-3xl font-bold", classNames.logo)}
          >
            {logo?.text}
          </Link>
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6">
          {footer8Defaults.social.map((item, i) => (
            <Link
              key={i}
              href={item.href}
