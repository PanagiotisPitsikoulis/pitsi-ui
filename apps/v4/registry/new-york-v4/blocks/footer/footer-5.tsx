...
const footer5Defaults = {
  brandStatement:
    "Growing happiness, one plant at a time. Your journey to a greener life starts here.",
  logo: {
    text: "Green Therapy",
    href: "#",
  },
...
export function Footer5({ content = {}, classNames = {} }: FooterBlockProps) {
  const {
    logo = footer5Defaults.logo,
    columns = footer5Defaults.columns,
    social = footer5Defaults.social,
    copyright = footer5Defaults.copyright,
    bottomLinks = footer5Defaults.bottomLinks,
  } = content

  return (
    <footer
      className={cn(
        "bg-gradient-to-b from-green-950 to-green-900 text-white",
        classNames.root
      )}
    >
      {/* Brand Statement with TextGradientOpacity */}
      <div className={cn("container px-6 pt-20 pb-16", classNames.container)}>
        <TextGradientOpacity
          text={footer5Defaults.brandStatement}
          className="max-w-3xl"
...
export { Footer5 as FooterGradientPlants }
