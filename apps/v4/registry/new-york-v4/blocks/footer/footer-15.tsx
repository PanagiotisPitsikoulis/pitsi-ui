...
const footer15Defaults = {
  brandStatement:
    "Discover extraordinary destinations. Create unforgettable memories. Your journey begins here.",
  logo: {
    text: "Wanderlust",
    href: "#",
  },
...
export function Footer15({ content = {}, classNames = {} }: FooterBlockProps) {
  const {
    logo = footer15Defaults.logo,
    columns = footer15Defaults.columns,
    social = footer15Defaults.social,
    copyright = footer15Defaults.copyright,
    bottomLinks = footer15Defaults.bottomLinks,
  } = content
  ...
  return (
    ...
    >
      ...
      <div className={cn("container px-6 pt-20 pb-16", classNames.container)}>
        <TextGradientOpacity
          text={footer15Defaults.brandStatement}
          className="max-w-3xl"
