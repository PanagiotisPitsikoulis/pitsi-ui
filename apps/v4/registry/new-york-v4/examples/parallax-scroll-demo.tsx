...
import ParallaxScroll from "@/registry/new-york-v4/animations/parallax-scroll/parallax-scroll"
      ...
      <div className="flex min-h-[400px] w-full items-center justify-center">
        <ParallaxScroll>
          <div className="bg-card rounded-lg border p-8 text-center">
            <h3 className="text-2xl font-bold">Parallax Scroll Animation</h3>
            <p className="text-muted-foreground mt-2">
              This element moves with parallax effect as you scroll
            </p>
          </div>
        </ParallaxScroll>
      </div>
