...
import { ChartCodeViewer } from "@/components/documentation/charts/chart-code-viewer"
import { ChartCopyButton } from "@/components/documentation/charts/chart-copy-button"
import { Chart } from "@/components/documentation/charts/chart-display"
    ...
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <div className="ml-auto flex items-center gap-2 [&>form]:flex">
        <ChartCopyButton
          ...
          className="[&_svg]-h-3 text-foreground hover:bg-muted dark:text-foreground h-6 w-6 rounded-[6px] bg-transparent [&_svg]:w-3"
        />
        <Separator
