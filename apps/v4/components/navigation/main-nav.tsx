...
export function MainNav({
  ...
  const toolsItem = items.find((item) => item.href === "/tools")
  ...
  return (
    <NavigationMenu className={cn("items-center", className)}>
      <NavigationMenuList>
        {/* Regular nav items */}
        {otherItems.map((item) => (
        ...
        {/* Tools dropdown */}
        {toolsItem && toolPages.length > 0 && (
          <NavigationMenuItem>
            <NavigationMenuTrigger
              className={cn(
                "text-muted-foreground hover:text-foreground bg-transparent hover:bg-transparent data-[state=open]:bg-transparent",
                isActive(toolsItem.href) && "text-foreground"
              )}
            >
              {toolsItem.label}
            </NavigationMenuTrigger>
                ...
                <div className="flex w-[180px] shrink-0 flex-col gap-2">
                  <NavigationMenuLink asChild>
                    ...
                    >
                      ...
                      <p className="text-muted-foreground text-sm leading-tight">
                        Designer tools for themes, shadows, spacing, and more.
                      </p>
                    </Link>
                  </NavigationMenuLink>
                  <div className="relative">
                  ...
                  <div className="mt-auto flex items-end justify-center">
                    <ToolsIcon className="text-brand size-20" />
                  </div>
                </div>
                <div className="grid h-[340px] flex-1 grid-cols-3 gap-4">
                  <ul className="flex flex-col gap-1">
                    {toolPages
                      .filter((page) =>
                        page.name.toLowerCase().includes(toolsSearch.toLowerCase())
                      )
                      .map((page) => (
                        <li key={page.url}>
                          <NavigationMenuLink asChild>
