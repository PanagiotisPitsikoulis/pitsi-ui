...
import { BarChart3, CreditCard, Database, Fingerprint } from "lucide-react"
      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16 lg:space-y-20 dark:[--color-border:color-mix(in_oklab,var(--color-white)_10%,transparent)]">
        ...
        <div className="grid gap-12 sm:px-12 md:grid-cols-2 lg:gap-20 lg:px-0">
          ...
          <div className="bg-background relative flex overflow-hidden rounded-3xl border p-2">
            <div
              aria-hidden
              className="absolute inset-y-0 right-0 w-16 border-l bg-[repeating-linear-gradient(-45deg,var(--color-border),var(--color-border)_1px,transparent_1px,transparent_8px)]"
            ></div>
            <div className="bg-background relative aspect-76/59 w-[calc(3/4*100%+3rem)] rounded-2xl">
              <AnimatePresence mode="wait">
                ...
                >
                  <Image
                    src={`https://tailark.com${images[activeItem].image}`}
