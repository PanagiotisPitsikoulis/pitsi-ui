...
export function SiteFooterClient({
  ...
  return (
    <footer
      className={`relative bg-transparent pt-12 pb-6 ${isDocsPage ? "pb-24 md:pb-6" : ""}`}
    >
      <div className="container px-6">
        ...
        <div
          className={`flex items-center justify-between pt-6 ${isHomePage ? "border-border border-t" : ""}`}
        >
