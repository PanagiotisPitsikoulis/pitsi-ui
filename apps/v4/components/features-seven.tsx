...
import { RiArrowUpLine, RiCalendarCheckLine, RiGlobalLine, RiLayoutLine, RiPlayLine, RiAddLine, RiQuillPenLine, RiSparklingLine, RiTargetLine } from '@remixicon/react'
                ...
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            ...
                            <RiLayoutLine className="text-primary size-5" />
                            ...
                            <div className="mask-b-from-95% -ml-2 -mt-2 mr-0.5 pl-2 pt-2">
                                <div className="bg-background rounded-tl-(--radius) ring-foreground/5 relative mx-auto mt-8 h-96 overflow-hidden border border-transparent shadow ring-1">
                                    <Image
                                        src="https://tailark.com/mist/tailark-2.png"
                                        alt="app screen"
                                        width="2880"
                                        height="1842"
                        ...
                        <Card
                            ...
                            <RiTargetLine className="text-primary size-5" />
                            <h3 className="text-foreground mt-5 text-lg font-semibold">AI Code Generation</h3>
                        ...
                        <Card
                            ...
                            <RiCalendarCheckLine className="text-primary size-5" />
                        ...
                        <Card
                            variant="soft"
                            className="group overflow-hidden px-6 pt-6">
                            <RiSparklingLine className="text-primary size-5" />
    ...
    return (
        <div
            ...
            <Card className="aspect-video w-4/5 translate-y-4 p-3 transition-transform duration-200 ease-in-out group-hover:-rotate-3">
                ...
                <RiQuillPenLine className="ml-8 mt-3 size-5" />
            </Card>
            <Card className="aspect-3/5 absolute -top-4 right-0 flex w-2/5 translate-y-4 p-2 transition-transform duration-200 ease-in-out group-hover:rotate-3">
                <div className="bg-foreground/5 m-auto flex size-10 rounded-full">
                    <RiPlayLine className="fill-foreground/50 stroke-foreground/50 m-auto size-4" />
                </div>
            </Card>
        </div>
    )
...
const AIAssistantIllustration = () => {
    return (
        <Card
            ...
            <div className="w-fit">
                <RiSparklingLine className="size-3.5 fill-purple-300 stroke-purple-300" />
