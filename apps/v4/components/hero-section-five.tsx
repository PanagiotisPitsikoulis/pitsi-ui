...
const MistKitLogo = ({ className }: { className?: string }) => (
    <div
        ...
        <RiBookOpenLine className="mask-b-from-25% size-6 fill-white stroke-white drop-shadow-sm" />
        <RiBookOpenLine className="absolute inset-0 m-auto size-6 fill-white stroke-white opacity-65 drop-shadow-sm" />
