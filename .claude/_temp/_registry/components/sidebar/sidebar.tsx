      ...
      <Flex
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=left]:border-border-elevation-2 group-data-[side=right]:border-l group-data-[side=right]:border-border-elevation-2",
          className
        )}
        {...props}
      >
        <Flex
          ...
          className="bg-background-elevation-2 h-full w-full group-data-[variant=floating]:bg-background-elevation-2 group-data-[variant=floating]:border group-data-[variant=floating]:border-border-elevation-2 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-regular-md group-data-[variant=inset]:bg-background-elevation-0 group-data-[variant=inset]:border-0"
        >
          {children}
        </Flex>
      </Flex>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  ...
  return (
    <main
      ...
      className={cn(
        "bg-background-elevation-0 pb-20 relative flex w-full flex-1 flex-col overflow-clip",
    ...
    <InputRoot size="xsmall">
      <InputWrapper>
        <Input
          ...
          data-sidebar="input"
          className={cn("bg-background-elevation-0 h-8 w-full", className)}
          {...props}
        />
      </InputWrapper>
    </InputRoot>
  ...
  return (
    <Flex className="w-full px-2">
      <Divider
        ...
        className={cn("w-full border-border-elevation-1", className)}
        {...props}
      />
    </Flex>
  )
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <Flex
      ...
      className={cn(
        "w-full min-h-0 flex-1 overflow-auto p-2 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-text-strength-500 ring-border-elevation-2 flex h-8 shrink-0 items-center rounded-md px-2 text-sm capitalize outline-none transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-text-strength-600 ring-border-elevation-2 hover:bg-background-elevation-0 hover:text-text-strength-900 absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-text-strength-600 ring-border-elevation-2 hover:bg-background-elevation-0 hover:text-text-strength-900 peer-hover/menu-button:text-text-strength-900 absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "group-data-[variant=inset]:hover:bg-background-elevation-2",
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuBadge({
  ...
  return (
    <Flex
      ...
      className={cn(
        "text-text-strength-600 pointer-events-none absolute right-1 h-5 min-w-5 rounded-md px-1 select-none bg-background-elevation-0 border border-border-elevation-0",
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-text-strength-600 ring-border-elevation-2 hover:bg-background-elevation-0 hover:text-text-strength-900 active:bg-background-elevation-0 active:text-text-strength-900 flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 transition-[background-color] [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
