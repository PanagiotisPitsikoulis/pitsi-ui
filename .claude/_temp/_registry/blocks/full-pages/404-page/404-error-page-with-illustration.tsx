export default function ErrorPageWithIllustration() {
  return (
    <section>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
          <div className="w-full flex-col justify-start items-center lg:gap-11 md:gap-8 gap-6 flex">
            <div className="w-full flex-col justify-start items-center md:gap-6 gap-4 flex">
              <h2 className="text-center text-indigo-500 text-5xl font-bold font-manrope leading-tight">
                Oops! Lost in Cyberspace?
              </h2>
              <p className="lg:max-w-2xl w-full text-center text-gray-600 text-base font-medium leading-relaxed">
                we'll help you find your way back. Explore our platform to
                discover the tools and resources you need to stay.
              </p>
            </div>
            <div className="w-full justify-center items-center sm:gap-2.5 gap-4 flex sm:flex-row flex-col">
              <input
                type="text"
                className="sm:w-96 w-full h-14 focus:outline-none px-5 py-3 rounded-lg shadow-xs border border-gray-300 text-gray-900 placeholder-gray-400 text-lg font-normal leading-relaxed"
                placeholder="Search our site"
              />
              <button className="sm:w-fit w-full px-6 py-3 bg-indigo-500 hover:bg-indigo-600 transition-all duration-500 ease-in-out rounded-xl shadow justify-center items-center flex">
