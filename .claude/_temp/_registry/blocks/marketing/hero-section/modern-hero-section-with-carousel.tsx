export default function ModernHeroSectionWithCarousel() {
  return (
    <div className="bg-[url('https://pagedone.io/asset/uploads/1719831800.png')] w-full bg-no-repeat bg-cover bg-center">
            ...
            >
              <ul className="flex lg:items-center lg:justify-center flex-col gap-6 max-lg:pt-4 max-lg:mb-4 lg:mt-0 lg:flex-row lg:mx-auto ">
                <li>
                  <a
                    href="javascript:;"
                    className="nav-link block lg:mx-3 md:mb-0 lg:text-left text-base text-white font-medium transition-all duration-500 hover:text-gray-200"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle flex items-center justify-between text-white text-center text-base font-medium transition-all duration-500 lg:mx-3 lg:mb-0 mr-auto lg:text-left lg:m-0 hover:text-gray-200"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
          ...
          <div className="swiper mySwiper">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="w-full lg:pt-32 pt-10 pb-14 flex-col justify-start items-start lg:gap-32 gap-16 inline-flex">
                  <div className="flex-col justify-start items-start gap-7 flex">
                    <h2 className="lg:max-w-5xl w-full text-white sm:text-7xl text-5xl font-medium font-manrope sm:leading-snug leading-snug">
                      Creating Inspiring Residential Environments.
                    </h2>
                    <p className="lg:max-w-xl w-full text-gray-300 text-base font-medium leading-relaxed">
                  ...
                  <div className="w-full justify-start items-center gap-24 inline-flex">
                    <div className="justify-start items-center gap-[18px] flex">
                      <div className="rounded-lg flex-col justify-center items-center gap-2.5 inline-flex">
                        ...
                        />
                        <a className="w-8 h-8 bg-white rounded-full flex items-center justify-center absolute">
                          {/* SVG removed */}
                        </a>
                      </div>
                      <p className="md:max-w-sm w-full text-gray-200 text-sm font-normal leading-normal">
            ...
            <button
              ...
              className="swiper-button-prev hidden relative lg:absolute left-[89%] mr-6 group lg:flex p-3 justify-center items-center bg-Neutral-800 hover:bg-Neutral-500 w-[50px] h-[50px] transition-all duration-700 ease-in-out rounded-full"
              data-carousel-prev
            >
              {/* SVG removed */}
            </button>
            <button
              ...
              className="swiper-button-next hidden relative lg:absolute left-[95%] group lg:flex p-3 justify-center items-center bg-Neutral-800 hover:bg-Neutral-900 w-[50px] h-[50px] transition-all duration-700 ease-in-out rounded-full "
              data-carousel-next
            >
              {/* SVG removed */}
            </button>
