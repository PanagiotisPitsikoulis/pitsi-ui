export default function CreativeHeroSectionWithBackgroundImage() {
  return (
    <div className="bg-[url('https://pagedone.io/asset/uploads/1719555887.png')] w-full bg-no-repeat bg-cover bg-center">
          ...
          <div className="w-full flex flex-col lg:flex-row">
            ...
            >
              <ul className="flex lg:items-center flex-col gap-6 mt-4 lg:mt-0 lg:flex-row max-lg:mb-4">
                ...
                <li className="relative px-1.5">
                  <button
                    ...
                    className="dropdown-toggle flex items-center justify-between text-white text-base font-medium hover:text-gray-400 transition-all duration-500 lg:mb-0 mr-auto lg:text-left  lg:m-0"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
              ...
              <div className="flex lg:items-center justify-start flex-col lg:flex-row gap-5 lg:flex-1 lg:justify-end">
                <button className="group border border-white hover:border-gray-200 rounded-full text-center transition-all duration-700 ease-in-out py-2 px-3.5">
                  <span className="px-1.5 text-sm font-medium leading-6 text-white group-hover:text-gray-100 transition-all duration-700 ease-in-out">
                    Login
                  </span>
                </button>
                <button className="bg-white rounded-full text-center shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-500 py-2 px-3.5 hover:bg-gray-100">
      ...
      <section className="w-full lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full md:pt-44 pt-10 md:pb-44 pb-28 flex-col justify-start items-start gap-2.5 inline-flex">
            <h2 className="text-white xl:text-[113px] sm:text-8xl text-7xl xl:leading-tight sm:leading-tight leading-snug font-playfairDisplay">
              Finding Your
            </h2>
            <div className="w-full justify-start items-center xl:gap-14 gap-7 flex xl:flex-row flex-col-reverse xl:pb-0 pb-5">
              <p className="w-full text-white text-xl font-normal font-playfairDisplay leading-relaxed xl:text-start text-center">
                Experience the art of redefined luxury living where comfort
                seamlessly intertwines with elegance. At our company, we
                specialize.
              </p>
              <h2 className="w-full text-white xl:text-[113px] sm:text-8xl text-7xl xl:leading-tight text-right sm:leading-tight leading-snug font-playfairDisplay whitespace-nowrap">
                Dream Home
              </h2>
            </div>
            <button className="sm:w-fit w-full xl:ml-0 mx-auto px-5 py-2.5 bg-white hover:bg-gray-100 transition-all duration-700 ease-in-out rounded-xl shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
