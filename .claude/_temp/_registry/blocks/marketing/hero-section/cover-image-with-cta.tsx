export default function CoverImageWithCta() {
  return (
    <div>
      ...
      <section className="lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full lg:py-14 py-10 flex-col justify-start items-start lg:gap-16 gap-10 inline-flex">
            <div className="w-full flex-col justify-start items-center lg:gap-9 gap-7 flex">
              <div className="w-full flex-col justify-start items-center gap-5 flex">
                <h2 className="lg:max-w-3xl w-full text-center text-gray-900 md:text-5xl text-5xl font-bold font-manrope md:leading-snug leading-tight">
                  Navigating Financial Waters with Confidence and Expertise
                </h2>
                <p className="lg:max-w-4xl w-full text-center text-gray-500 text-base font-normal leading-relaxed">
                  Financial Waters with Confidence and Expertise involves
                  skillfully managing financial matters, whether personal or
                  professional, with a profound sense of assurance and
                  proficiency.
                </p>
              </div>
            ...
            <div className="flex-col justify-start items-start flex relative">
              <img
                className="w-full object-cover"
                src="https://pagedone.io/asset/uploads/1720172082.png"
              />
            </div>
          </div>
        </div>
