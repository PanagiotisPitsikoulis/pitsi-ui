export default function EcommerceHeroSection() {
  return (
    <div>
      <nav className="py-5 lg:fixed transition-all top-0 left-0 z-50 duration-500 w-full bg-white  border-b border-gray-200">
    ...
    https://pagedone.io/"
      ...
      <section className="relative py-14 lg:pt-36 lg:pb-14 ">
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8 mb-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-md mx-auto md:max-w-2xl lg:max-w-full">
            <div className="rounded-2xl relative group overflow-hidden cursor-pointer">
              <img
                src="https://pagedone.io/asset/uploads/1710221193.png"
                className="relative z-0 w-full h-full transition-all duration-700 group-hover:scale-110 rounded-2xl object-cover"
              />
              <div className="absolute top-0 w-full h-full z-10 left-0 p-7 rounded-2xl">
                <h3 className="font-manrope font-bold text-5xl text-white whitespace-nowrap">
                  Nike Air Max
                </h3>
                <div className="flex items-end pb-10 justify-end w-full h-full gap-2.5">
                  <div className="flex items-center gap-2.5">
                    <button className="rounded-full py-2 px-6 bg-white text-base font-semibold leading-8 shadow-xs text-black whitespace-nowrap transition-all duration-500 hover:bg-black hover:text-white">
                      Explore All
                    </button>
                    <button className="rounded-full w-12 h-12 flex items-center justify-center bg-white text-xl font-normal leading-8 text-black transition-all duration-500 hover:bg-black hover:text-white">
                      {/* SVG removed */}
                    </button>
                  </div>
                </div>
            ...
            <div className="rounded-2xl relative group cursor-pointer overflow-hidden">
              <img
                src="https://pagedone.io/asset/uploads/1710221205.png"
                className="relative z-0 w-full h-full transition-all duration-700 group-hover:scale-105 rounded-2xl object-cover"
              />
              <div className="absolute top-0 w-full h-full z-10 left-0 p-7 rounded-2xl">
                <div className="flex items-center justify-between gap-2.5">
                  ...
                  <button className="rounded-full w-12 h-12 flex items-center justify-center bg-white text-xl font-normal leading-8 text-black transition-all duration-500 hover:bg-black hover:text-white group-hover:rotate-45">
                    {/* SVG removed */}
                  </button>
                </div>
                <div className="flex justify-end flex-col w-full h-[calc(100%-70px)]">
                  <p className="text-base font-normal text-gray-900">
                    Our reputation gleams as brightly as our stylish,
                    high-quality shoes—crafted for enduring fashion and
                    unmatched durability, making them the best choice for
                    everyone
                  </p>
                </div>
              </div>
