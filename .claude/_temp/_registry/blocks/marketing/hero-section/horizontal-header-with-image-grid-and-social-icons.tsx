          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-28">
            <div className="flex items-center w-full max-lg:max-w-xl mx-auto">
              <div className="block">
                <span className="inline-flex items-center bg-indigo-50 text-indigo-600 text-sm font-medium mr-2 pl-2 pr-2.5 rounded-full py-1 mb-8">
                  <span className="w-1.5 h-1.5 mr-1.5 rounded-full bg-indigo-600 flex" />
                  Podcasts
                </span>
                ...
                <div className="flex flex-col min-[450px]:flex-row items-center gap-5 mb-8">
                  <button className="flex items-center max-[450px]:w-full max-[450px]:justify-center rounded-lg gap-2 py-3 pr-5 pl-7 bg-indigo-600 text-white text-base font-semibold transition-all duration-500 hover:bg-indigo-700">
                    Get started
                    {/* SVG removed */}
                  </button>
                  <button className="flex items-center max-[450px]:w-full max-[450px]:justify-center rounded-xl gap-2 py-3 px-7 bg-indigo-50 text-indigo-600 text-base font-semibold shadow-sm shadow-transparent transition-all duration-500 hover:shadow-transparent hover:border-indigo-50 hover:bg-indigo-100">
                    See Demo
                  </button>
                </div>
            ...
            <div className="grid grid-cols-2 gap-5 relative">
              <img
                ...
                className="max-lg:ml-auto object-cover"
              />
              <div className="flex items-end justify-start relative">
                ...
                <img
                  ...
                  className="absolute top-0 left-0 w-40 aspect-square z-0 object-cover"
                />
              </div>
              ...
              <img
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 object-cover"
              />
            </div>
          </div>
        </div>
