export default function VerticalHeroWithCoverImage() {
  return (
    <div>
      <nav className="py-5 lg:fixed w-full bg-white transition-all z-50 duration-500">
        ...
        https://pagedone.io/"
            ...
            <div
              ...
              id="navbar"
            >
              <ul className="flex lg:items-center lg:justify-center gap-6 py-6 flex-col lg:mx-auto ">
                <li>
                  <a
                    href="javascript:;"
              ...
              <div className="mx-auto flex lg:items-center w-full justify-start flex-col lg:flex-row gap-5 lg:w-max max-lg:gap-5 lg:justify-end">
                <button className="flex items-center justify-center bg-violet-200 rounded-lg cursor-pointer shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 py-2 px-3.5 hover:bg-violet-300">
                  {/* SVG removed */}
      ...
      <section className="w-full lg:pt-24 pt-10 pb-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full flex-col justify-start items-start xl:gap-20 lg:gap-14 gap-12 inline-flex">
            <img
              className="lg:h-auto md:h-[460px] h-[400px] rounded-3xl object-cover"
            ...
            <div className="w-full justify-start lg:items-start items-center xl:gap-10 gap-8 grid lg:grid-cols-2 grid-cols-1">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-5 inline-flex">
                <div className="px-2.5 py-0.5 bg-amber-100 rounded-full justify-start items-center gap-1.5 flex">
                  <span className="text-center text-black text-xs font-medium leading-normal">
              ...
              <div className="w-full h-full flex-col justify-between lg:items-start items-center inline-flex lg:gap-0 gap-5">
                <p className="text-gray-900 text-base font-normal leading-relaxed lg:text-start text-center">
                ...
                <button className="sm:w-fit w-full px-5 py-2.5 bg-amber-400 hover:bg-amber-500 transition-all duration-700 ease-in-out rounded-full shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
