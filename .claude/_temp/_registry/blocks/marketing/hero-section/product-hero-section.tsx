    ...
    https://pagedone.io/"
      ...
      <section className="relative py-14 lg:pt-36 lg:pb-14 ">
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-12 gap-8 max-w-md mx-auto md:max-w-3xl lg:max-w-full">
            <a
              href="javascript:;"
              className="col-span-12 lg:col-span-8 group overflow-hidden"
            >
              <div className="rounded-2xl relative overflow-hidden">
                ...
                />
                <div className="absolute top-0 left-0 z-10 p-8 w-full h-full flex items-start">
                  <div className="block">
                    <h4 className="font-manrope font-medium text-4xl md:text-5xl md:leading-relaxed text-white mb-2.5">
                      The Essential <br />
                      Smart <br />
                      Watch
                    </h4>
                    <p className="text-base font-normal text-white max-w-xs w-48 md:w-full">
            ...
            <div className="col-span-12 lg:col-span-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8 ">
              <div className="rounded-2xl relative overflow-hidden group">
                <img
                  src="https://pagedone.io/asset/uploads/1710221321.png"
                  alt="men with t-shirt"
                  className="relative z-0 w-full h-full rounded-2xl object-cover"
                />
                <div className="absolute top-0 left-0 z-10 p-8 w-full h-full flex justify-between flex-col">
                  <h4 className="font-manrope font-semibold text-4xl leading-snug text-white mb-1.5">
                    JBL Tune <br />
                    760NC
                  </h4>
                  <button className="rounded-full w-16 h-16 flex items-center justify-center bg-transparent border border-white text-xl font-normal leading-8 text-white hover:bg-white hover:text-gray-900 transition-all duration-500 group-hover:rotate-45">
                    {/* SVG removed */}
                  </button>
                </div>
              </div>
              <div className="rounded-2xl relative group">
                ...
                />
                <div className="absolute top-0 left-0 z-10 p-8 w-full h-full flex justify-between flex-col">
                  <h4 className="font-manrope font-semibold text-4xl leading-snug text-black mb-1.5">
                    Sony SRS-XB100 <br />
                    Speakers
                  </h4>
                  <button className="rounded-full w-16 h-16 flex items-center justify-center bg-transparent border border-black text-xl font-normal leading-8 text-black hover:bg-black hover:text-white  transition-all duration-500 group-hover:rotate-45">
                    {/* SVG removed */}
                  </button>
                </div>
              </div>
