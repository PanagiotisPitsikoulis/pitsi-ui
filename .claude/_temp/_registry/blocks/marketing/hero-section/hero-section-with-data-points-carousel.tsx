  ...
  return (
    <div>
      ...
      <section className="relative py-14 lg:pt-36 lg:pb-14 ">
        <div className="w-full max-w-4xl mx-auto px-4 lg:px-8 mb-14">
          <h1 className="font-manrope font-bold text-4xl sm:text-5xl leading-tight text-gray-900 mb-7 text-center">
            Empowering Your Growth Journey with Modern{" "}
            <span className="text-indigo-600">Capital Solutions</span>
          </h1>
          <p className="mb-7 text-base font-normal text-gray-500 text-center">
          ...
          <button className="py-3.5 pr-5 max-sm:w-full max-sm:justify-center pl-7 rounded-full bg-indigo-600 text-white flex items-center gap-2 text-base font-semibold w-max mx-auto transition-all duration-500 hover:bg-indigo-700">
            Unlock Capital
            {/* SVG removed */}
          </button>
        </div>
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 overflow-hidden py-2 max-w-sm mx-auto max-md:px-3 md:max-w-full">
          <div className="block w-full rounded-3xl overflow-hidden">
            <img
              src="https://pagedone.io/asset/uploads/1709272622.png"
              className="md:w-full h-auto rounded-3xl object-cover"
            />
          </div>
          <div className="flex w-full h-full items-center rounded-3xl max-md:py-10 shadow-[0px_0px_15.5px_0px_rgba(0,0,0,0.10)]">
            <img
          ...
          <div className="flex w-full h-full items-center justify-center max-md:py-10 rounded-3xl shadow-[0px_0px_15.5px_0px_rgba(0,0,0,0.10)]">
            <img
