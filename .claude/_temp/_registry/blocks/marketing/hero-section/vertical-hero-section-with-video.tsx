export default function VerticalHeroSectionWithVideo() {
  return (
    <div className="bg-gray-50">
      <nav className="py-5 transition-all duration-500 w-full bg-white border-b border-solid border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full flex flex-col lg:flex-row">
            ...
            <div
              className="hidden w-full lg:flex lg:pl-11 max-lg:h-screen max-lg:overflow-auto max-lg:pb-8"
              id="navbar"
            >
              <ul className="flex lg:items-center max-lg:py-6 max-lg:gap-4 flex-col lg:mt-0 lg:flex-row ml-auto">
                <li>
                  <a
                    href="javascript:;"
                    className="text-gray-500 text-base font-medium block lg:mr-6 md:mb-0 lg:text-left transition-all duration-500 hover:text-gray-900"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle flex items-center justify-between text-gray-500 text-center text-base font-medium hover:text-prime-blue-700 transition-all duration-500 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
                  ...
                  <div
                    ...
                    className="animate-fade z-10 relative top-3 max-lg:mb-3 lg:absolute lg:top-14 lg:-left-80 bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] xl:p-8 lg:p-4 p-2 lg:min-w-[800px] md:min-w-[500px] min-w-full hidden"
                  >
                ...
                <li className="relative">
                  ...
                  <div
                    ...
                    className="dropdown-menu z-10 relative top-3 max-lg:mb-3 lg:absolute lg:top-14 font-normal bg-white rounded-lg shadow-[0px_15px_30px_-4px_rgba(16,24,40,0.03)] w-64 xl:p-8 lg:p-4 p-2 hidden"
                  >
                    <ul
      ...
      <section className="relative py-5 lg:py-20 overflow-hidden before:content-[''] before:absolute before:bottom-0 before:bg-indigo-600 before:w-full before:h-28 lg:before:h-2/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 mb-24 lg:grid-cols-12 xl:gap-24 lg:gap-6 gap-4 items-center">
            <div className="w-full lg:col-span-6 lg:pb-0 pb-12 md:order-first">
              <div className="text-center lg:text-left lg:max-w-xl">
                <span className="bg-white rounded-full flex items-center justify-center w-40 h-7 font-medium text-sm text-indigo-500 px-2 mb-2 ml-auto mr-auto lg:ml-0 lg:mr-0">
                  {/* SVG removed */}
                  Finance organized
                </span>
                <h1 className="pb-5 text-center text-gray-900 font-extrabold font-manrope text-5xl lg:text-left leading-[50px]">
                ...
                <div className="flex flex-col md:flex-row gap-5 lg:justify-start justify-center">
                  <a
                    href="javascript:;"
                    className="bg-indigo-600 py-2 px-6 rounded-full flex items-center justify-center text-sm font-semibold text-white transition-all duration-500 h-11 focus:outline-none hover:bg-indigo-700"
                  >
                    Connect us
                  </a>
                  <a
                    href="javascript:;"
                    className="rounded-full py-2 pl-6 pr-4 gap-2 flex items-center justify-center text-base font-semibold text-indigo-600 transition-all duration-500 focus:outline-none hover:bg-indigo-50"
                  >
                    View more
                    {/* SVG removed */}
                  </a>
            ...
            <div className="w-full lg:col-span-6">
              <p className="text-lg text-gray-500 font-normal text-center lg:text-left">
          ...
          <div className="relative">
            ...
            />
            <button className="w-14 h-14 md:w-20 md:h-20 rounded-full border border-solid border-white bg-white bg-opacity-10 backdrop-blur-sm flex items-center justify-center absolute left-0 right-0 top-0 bottom-0 m-auto lg:w-28 lg:h-28">
              {/* SVG removed */}
            </button>
          </div>
        </div>
