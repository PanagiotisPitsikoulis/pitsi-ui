export default function HeroSectionWithCarouselSlider() {
  return (
    <div>
      <nav className="py-5 lg:fixed w-full transition-all z-50 bg-white duration-500 border-b border-gray-200">
      ...
      https://pagedone.io/"
            ...
            >
              ...
              <div className="flex lg:items-center w-full justify-start flex-col lg:flex-row gap-5 lg:w-max max-lg:gap-5 xl:ml-14 lg:ml-10 lg:justify-end">
                <div className="dropdown relative items-center flex px-1.5 py-0.5 bg-gray-100 rounded-full gap-1 h-[22px] ">
            ...
            h-[22px] w-[59px]"
                ...
                <button className="flex items-center justify-center bg-gray-900 rounded-lg cursor-pointer transition-all duration-700 ease-in-out py-2 px-3.5 hover:bg-gray-800">
                  <span className="px-1.5 text-gray-50 text-sm font-medium leading-6">
                    Login
                  </span>
                </button>
                <button className="flex items-center justify-center bg-amber-400 rounded-lg cursor-pointer shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out py-2 px-3.5 hover:bg-amber-500">
      ...
      <section className="lg:pt-[91px] pt-10 lg:pb-32 pb-10 relative">
        <div className="w-full lg:pt-14 flex-col justify-start items-center lg:gap-20 gap-12 inline-flex">
          <div className="w-full lg:px-28 sm:px-10 px-5 flex-col justify-start items-center gap-9 flex">
            <div className="w-full flex-col justify-start items-center gap-5 flex">
              <h2 className="max-w-3xl text-center text-gray-900 text-5xl font-bold font-manrope leading-[62px]">
            ...
            <button className="sm:w-fit w-full px-5 py-2.5 bg-amber-400 hover:bg-amber-500 transition-all duration-700 ease-in-out rounded-xl justify-center items-center flex">
          ...
          <div className="w-full flex-col justify-start items-center md:gap-16 gap-10 flex">
            <div className="justify-center items-center md:gap-14 gap-7 grid sm:grid-cols-4 grid-cols-2 sm:px-6 px-4">
              <a className="grayscale hover:grayscale-0 transition-all duration-700 ease-in-out">
                {/* SVG removed */}
              </a>
              <a className="grayscale hover:grayscale-0 transition-all duration-700 ease-in-out">
                {/* SVG removed */}
              ...
              <div className="swiper">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <img
                      className="w-[286px] h-full rounded-t-2xl object-cover"
                      src="https://pagedone.io/asset/uploads/1718955005.png"
                    />
                  </div>
                  <div className="swiper-slide">
                    <img
                      className="w-[286px] h-full rounded-t-full rounded-b-2xl object-cover"
