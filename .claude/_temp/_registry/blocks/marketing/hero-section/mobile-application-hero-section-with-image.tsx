export default function MobileApplicationHeroSectionWithImage() {
  return (
    <div>
      <div className="h-screen 2xl:w-[37%] xl:w-[33%] fixed right-0 hidden xl:block">
        <img
      ...
      <nav className="py-5 lg:fixed w-full z-50 transition-all duration-500">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full flex flex-col lg:flex-row">
            ...
            <div
              className="hidden w-full lg:flex lg:pl-11 max-lg:bg-white max-lg:py-4 space-y-4 max-lg:mt-1"
              id="navbar"
            >
              <ul className="flex lg:items-center max-lg:gap-4 flex-col mt-4 lg:mt-0 lg:flex-row">
                <li>
                  <a
                    href="javascript:;"
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle flex items-center justify-between text-gray-500 text-base lg:text-base font-medium hover:text-indigo-700 transition-all duration-500 mb-2 lg:mr-6 md:mb-0 lg:text-left lg:m-0"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
                  ...
                  <div
                    ...
                    className="animate-fade z-10 relative top-3 lg:absolute lg:top-14 hidden lg:-left-80 bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] xl:p-8 lg:p-4 p-2 lg:min-w-[800px] md:min-w-[500px] min-w-full"
                  >
                ...
                <li className="relative">
                  ...
                  <div
                    ...
                    className="dropdown-menu z-10 hidden relative lg:absolute top-2 lg:top-6 font-normal bg-white rounded-lg shadow-lg shadow-gray-200 w-64 xl:p-8 lg:p-4 p-2"
                  >
                    <ul
              ...
              <div className="flex flex-col lg:flex-row max-lg:gap-4 lg:items-center justify-start lg:flex-1 lg:justify-end">
      ...
      <section className="relative pt-6 lg:pt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-24 gap-6 overflow-hidden items-center">
            <div className="w-full lg:col-span-6 lg:pb-0 pb-12 md:order-first">
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <div className="flex flex-col md:flex-row lg:justify-start justify-center mb-24 gap-5">
                  <a
                    href="javascript:;"
                    className="bg-indigo-600 py-4 px-5 rounded-full flex items-center justify-center gap-2 text-base font-semibold text-white transition-all duration-500 focus:outline-none hover:bg-indigo-700"
                  >
                    {/* SVG removed */}
                    Download now
                  </a>
                  <a
                    href="javascript:;"
                    className="bg-indigo-50 py-4 px-5 rounded-full flex items-center justify-center gap-2 text-base font-semibold text-indigo-600 transition-all duration-500 focus:outline-none hover:bg-indigo-100"
                  >
                    {/* SVG removed */}
                    How it works
                  </a>
                </div>
                <div className="flex flex-col md:flex-row lg:justify-start justify-center md:gap-14 gap-4">
                  <div className="relative">
                    <h4 className="text-3xl text-black font-bold mb-3">
                      500K+
                    </h4>
