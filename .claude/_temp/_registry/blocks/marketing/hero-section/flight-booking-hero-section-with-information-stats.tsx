  ...
  return (
    <div>
          ...
          <div className="w-full flex flex-col lg:flex-row">
            <div className="flex justify-between lg:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center p-2 ml-3 text-sm text-gray-900 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
            ...
            >
              <ul className="flex lg:items-center flex-col gap-6 mt-4 lg:mt-0 lg:flex-row max-lg:mb-4">
                <li className="px-1.5">
                  <a
                    href="javascript:;"
                    className="text-gray-400 text-base font-medium hover:text-gray-900 transition-all duration-500 lg:px-1.5 block lg:text-left "
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative px-1.5">
                  <button
                    ...
                    className="dropdown-toggle flex items-center justify-between text-gray-400 text-base font-medium transition-all duration-500 mr-auto lg:text-left lg:m-0 hover:text-gray-900"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
              ...
              <div className="flex lg:items-center justify-start flex-col lg:flex-row gap-5 lg:flex-1 lg:justify-end">
                <button className="bg-black rounded-full text-center transition-all duration-500 py-2 px-3.5 hover:bg-gray-800">
                  <span className="px-1.5 text-sm font-medium leading-6 text-white">
                    Login
                  </span>
                </button>
                <button className="bg-emerald-600 rounded-full text-center shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-500 py-2 px-3.5 hover:bg-emerald-700">
      ...
      <section className="w-full lg:pt-[84px]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full lg:py-14 py-8 justify-center items-center lg:gap-4 gap-8 grid lg:grid-cols-2 grid-cols-1">
            <div className="flex-col justify-start lg:items-start items-center lg:gap-20 gap-10 inline-flex">
              <div className="flex-col justify-start lg:items-start items-center lg:gap-12 gap-10 flex">
                <div className="flex-col justify-start lg:items-start items-center gap-4 flex">
                  <h2 className="text-gray-900 sm:text-6xl text-5xl font-semibold font-manrope sm:leading-snug leading-snug lg:text-start text-center">
                    We make your Flight
                ...
                <div className="w-full lg:justify-start justify-center items-start gap-8 flex sm:flex-row flex-col">
                  <button className="sm:w-fit w-full px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 transition-all duration-700 ease-in-out rounded-xl shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
                    <span className="px-2 py-px text-white text-base font-semibold leading-relaxed">
                      Booking Now
                    </span>
                    {/* SVG removed */}
                  </button>
                  <button className="sm:w-fit w-full px-5 py-2.5 bg-emerald-100 hover:bg-emerald-200 transition-all duration-700 ease-in-out rounded-xl justify-center items-center flex">
              ...
              <div className="w-full lg:justify-start justify-center lg:items-start items-center flex xl:gap-9 lg:gap-3 sm:gap-6 gap-5 lg:grid lg:grid-cols-3">
                <div className="flex-col justify-start items-start gap-2 inline-flex xl:pr-9 lg:pr-3 sm:pr-6 pr-5 border-r border-gray-200">
                  <h6 className="text-gray-500 text-base font-normal leading-relaxed whitespace-nowrap">
                    Years Operated
                  </h6>
                  <h3 className="text-black text-2xl font-extrabold font-manrope leading-9 whitespace-nowrap">
                    48+ Years
                  </h3>
                </div>
                <div className="flex-col justify-start items-start gap-2 inline-flex xl:pr-9 lg:pr-3 sm:pr-6 pr-5 border-r border-gray-200">
                  ...
                  <h3 className="text-black text-2xl font-extrabold font-manrope leading-9">
                    50,000+
                  </h3>
                </div>
            ...
            <img
              ...
              className="w-full lg:h-full h-auto object-cover rounded-[24px]"
            />
          </div>
        </div>
      </section>
