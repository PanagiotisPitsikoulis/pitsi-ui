export default function PhoneMockupWithAppDownload() {
  return (
    <div>
      <div className="lg:h-screen w-[35%] fixed bg-gradient-to-l from-indigo-700 to-indigo-500 bg-fixed bg-right right-0 hidden lg:block" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full flex flex-col lg:flex-row">
            ...
            <div className="hidden w-full lg:flex lg:pl-11" id="navbar">
              <ul className="flex lg:items-center max-lg:gap-4 max-lg:mt-1 max-lg:py-4 flex-col mt-4 lg:mt-0 lg:flex-row">
                <li>
                  <a
                    href="javascript:;"
                    className="nav-link mb-2 block text-sm lg:text-base font-medium lg:mr-6 lg:mb-0 lg:text-left  text-gray-500"
                  >
                    Home
                  </a>
                </li>
                ...
                <li className="relative">
                  <button
                    data-target="menu1"
                    className="dropdown-toggle flex items-center justify-between text-gray-500 text-sm lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0"
                  >
                    Products
                    {/* SVG removed */}
                  </button>
                  ...
                  <div
                    ...
                    className="animate-fade z-10 relative top-3 lg:absolute lg:top-14 lg:-left-80 bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] xl:p-8 lg:p-4 p-2 lg:min-w-[800px] md:min-w-[500px] min-w-full hidden"
                  >
                ...
                <li className="relative">
                  ...
                  <div
                    ...
                    className="dropdown-menu z-10 relative top-3  lg:absolute lg:top-5 shadow-lg shadow-gray-200 font-normal bg-white rounded-lg w-64 xl:p-8 lg:p-4 p-2 hidden"
                  >
                    <ul
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-start max-lg:gap-4 lg:flex-1 lg:justify-end relative">
      ...
      <section className="relative h-full overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-24 gap-6 items-center h-full">
            <div className="w-full lg:col-span-6 lg:pb-0 pb-12 md:order-first">
              <div className="text-center lg:text-left lg:max-w-xl relative">
                ...
                <div className="flex flex-col lg:flex-row 2xl:mb-24 xl:mb-16 mb-10 gap-5">
                  <a
                    href="javascript:;"
                ...
                <div className="flex md:flex-row flex-col items-center justify-center lg:justify-start gap-5 lg:gap-7">
                  <a href="javascript:;">
                    <img
            ...
            <div className="w-full lg:col-span-6">
              <img
                ...
                className="relative w-2/3 xl:w-auto lg:w-4/5 mx-auto object-cover"
              />
            </div>
          </div>
        </div>
