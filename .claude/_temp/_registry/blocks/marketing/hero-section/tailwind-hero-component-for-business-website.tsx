export default function TailwindHeroComponentForBusinessWebsite() {
  return (
    <div>
      ...
      <section className="relative py-14 lg:pt-44 lg:pb-24 ">
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-28">
            <div className="block max-lg:order-last">
              <img
                src="https://pagedone.io/asset/uploads/1709271994.png"
                className="lg:w-full h-auto max-lg:mx-auto rounded-3xl object-cover"
              />
            </div>
            <div className="flex items-center w-full max-lg:max-w-xl mx-auto">
              <div className="block">
                <h1 className="font-manrope font-extrabold text-5xl leading-[1.2] text-gray-900 mb-7 max-[450px]:text-center">
                  Accelerate Your Transactions with{" "}
                  <span className="text-indigo-600">Seamless Efficiency</span>
                </h1>
                <p className="text-base font-medium text-gray-500 mb-7 max-[450px]:text-center">
                  Welcome to SwiftPay, where hero payment solutions are
                  reimagined for speed and simplicity. Say goodbye to clunky
                  processes and hello to instant, hassle-free transactions.
                </p>
                <div className="flex flex-col min-[450px]:flex-row items-center gap-5 mb-14 xl:mb-24">
                  <button className="flex items-center max-[450px]:w-full max-[450px]:justify-center rounded-lg gap-2 py-2.5 pr-5 pl-7 bg-indigo-600 text-white text-base font-semibold transition-all duration-500 hover:bg-indigo-700">
                    Get started
                    {/* SVG removed */}
                  </button>
                  <button className="flex items-center max-[450px]:w-full max-[450px]:justify-center rounded-lg gap-2 py-2.5 pr-5 pl-7 bg-white text-indigo-600 text-base font-semibold border border-gray-300 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-300 hover:border-indigo-100 hover:bg-indigo-100">
                    See Demo
                    {/* SVG removed */}
                  </button>
                </div>
                <div className="flex flex-col min-[450px]:flex-row items-center gap-8 min-[450px]:gap-28">
                  <div className="block">
                    <h4 className="font-manrope max-[450px]:text-center font-extrabold text-2xl leading-9 text-indigo-600 mb-2">
                      850K+
                    </h4>
                    <p className="text-base max-[450px]:text-center font-normal text-gray-500">
                      Satisfied users
                    </p>
                  </div>
                  <div className="block">
