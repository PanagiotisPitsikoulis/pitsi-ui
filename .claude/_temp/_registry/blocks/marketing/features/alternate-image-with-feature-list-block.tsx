  ...
  return (
    <section className="py-24 ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-center items-center gap-20 lg:flex-row lg:justify-between ">
          <div className="w-full lg:w-2/5">
            <div className="lg:max-w-lg">
              <div className="mb-11 max-lg:max-w-2xl max-lg:mx-auto">
                <span className="text-base text-left text-indigo-600 font-medium mb-2 block">
                  OUR FEATURES
                </span>
                <h2 className="text-3xl sm:text-4xl text-left font-bold text-gray-900 leading-[3.25rem] mb-5">
                ...
                <div className="lg:hidden p-5 bg-gray-50 rounded-3xl mt-5">
                  <img
              ...
              <ul className="grid gap-8 max-lg:max-w-2xl max-lg:mx-auto">
          ...
          <div className="w-full lg:w-3/5 bg-gray-50 rounded-3xl p-4 lg:p-10 max-lg:hidden">
            <img
              src="https://pagedone.io/asset/uploads/1695030979.png"
              alt="Dashboard image"
