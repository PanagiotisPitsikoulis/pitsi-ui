export default function FeatureBlocksWithPartialSlides() {
  return (
    <section className="py-24">
      <div className="w-full xl:pl-28 lg:pl-14 md:px-0 px-4 bg-white flex-col justify-start items-start gap-2.5 inline-flex">
        <div className="w-full justify-start items-center xl:gap-12 gap-7 grid lg:grid-cols-12 grid-cols-1">
          <div className="xl:col-span-3 lg:col-span-4 col-span-12 flex-col justify-center items-end gap-8 inline-flex">
            ...
            <div className="w-full lg:justify-start justify-center lg:items-start items-center gap-2.5 inline-flex">
              <button
                id="slider-button-left"
                className="swiper-button-prev group flex justify-center items-center w-[34px] h-[34px] bg-orange-50 rounded-md transition-all duration-700 ease-in-out hover:bg-orange-100"
                data-carousel-prev
              >
                {/* SVG removed */}
              </button>
              <button
                ...
                className="swiper-button-next group flex justify-center items-center w-[34px] h-[34px] bg-orange-50 rounded-md transition-all duration-700 ease-in-out hover:bg-orange-100"
                data-carousel-next
              >
                {/* SVG removed */}
              </button>
            ...
            <div className="swiper mySwiper">
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="w-full p-3 bg-gray-50 rounded-lg flex-col justify-start items-start gap-3 inline-flex">
                    ...
                    <p className="lg:max-w-60 max-w-96 text-gray-500 text-sm font-normal leading-relaxed">
