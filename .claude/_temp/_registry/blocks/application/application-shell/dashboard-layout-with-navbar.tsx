export default function DashboardLayoutWithNavbar() {
  return (
    <div className="relative bg-gray-50 dark:bg-gray-900">
      {/*header*/}
      <nav className="border-b lg:border-gray-200 dark:border-gray-700 dark:bg-gray-900 border-transparent py-3.5 px-6  w-full  fixed ">
        <div className="flex items-center justify-between gap-1 sm:gap-6 lg:flex-row flex-col">
          ...
          <div
            id="mobile-navbar"
            className="hidden lg:flex flex-row w-full flex-1 shadow-sm lg:shadow-none bg-white dark:bg-transparent lg:bg-transparent rounded-xl py-4 lg:py-0"
          >
