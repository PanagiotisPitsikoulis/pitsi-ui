export default function CreativeDashboardLayoutTailwind() {
  return (
    <div id="main" className="relative  group ">
      ...
      <aside
        id="sidemenu"
        className="group min-h-screen max-sm:w-full flex flex-col flex-shrink-0 group-[.is-open]:w-64 group-[.is-open]:translate-x-0 -translate-x-full lg:translate-x-0 absolute lg:fixed z-10 lg:w-16 transition-all duration-500 ease-in-out bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800"
      >
        {/*Sidebar Header*/}
        <div className="flex items-center justify-between flex-shrink-0  group-[.is-open]:flex-row gap-4 mx-4  py-6 border-b border-gray-200 dark:border-gray-800 ">
          <a href="#"></a>
          <button
            id="navbar-toggle"
        ...
        <div className="flex-shrink-0 mx-3 group-[.is-open]:mx-3">
          ...
          <div className="py-5  flex justify-between items-center border-t border-solid border-gray-200 dark:border-gray-800">
            ...
            <button className="rounded-full p-0.5 bg-white  hover:bg-gray-100 dark:bg-gray-700 lg:opacity-0 group-[.is-open]:opacity-100 transition-all duration-500 ease-in-out"></button>
          </div>
        </div>
      </aside>
      {/*main content*/}
      ...
      >
        <div className="absolute h-[200px] w-full top-0 left-0 bg-indigo-50 dark:bg-gray-800 -z-10" />
        <div className="flex justify-between items-center py-3.5 px-4 mx-4 border-b border-gray-200 dark:border-gray-700">
          <div className="block ">
            <div className="flex lg:hidden items-center justify-start gap-3 pb-8">
              <button
                id="toggleSidebarmobile"
                className="w-6 h-6 rounded-full flex lg:hidden items-center justify-center bg-gray-100 dark:bg-gray-700"
              ></button>
            </div>
            ...
            <div className="dropdown relative inline-flex">
              ...
              >
                <ul className="py-2 flex flex-col gap-2.5 px-3">
                  ...
                  <li className="flex items-center justify-start gap-1.5">
                    <button className="group py-2 px-2 lg:pr-5 lg:pl-3.5 flex items-center whitespace-nowrap gap-1.5 font-medium text-sm text-white border border-solid border-indigo-600 bg-indigo-600 rounded-lg transition-all duration-300 hover:bg-indigo-700 hover:border-indigo-700"></button>
                    <span className="text-sm font-medium text-gray-700">
                      Add Employee
                    </span>
                  </li>
        ...
        <div className="lg:grid  grid-cols-12 gap-12 p-8">
          <div className="col-span-12 lg:col-span-9 lg:mb-0 mb-8 ">
            <div className="p-6 border border-gray-200  bg-white  rounded-2xl">
              <div className="border-gray-200 border rounded-xl  lg:h-[700px] md:h-[400px] h-[350px]">
                <img
          ...
          <div className="col-span-12 lg:col-span-3 lg:mb-0 mb-8 ">
            <div className="p-6 border border-gray-200  bg-white rounded-2xl">
              <div className="border-gray-200 border rounded-xl lg:h-[700px] md:h-[400px] h-[350px]">
                <img
                  src="https://pagedone.io/asset/uploads/1712309277.png"
