          ...
          >
            <div className="opacity-1 ease-out sm:max-w-sm sm:w-full m-5 relative top-1/2 -translate-y-1/2 sm:mx-auto modal-open:opacity-100 transition-all modal-open:duration-500">
              <div className="bg-white p-6">
                ...
                <h6 className="text-lg font-bold leading-8 text-gray-900 mb-2">
                ...
                <form action="#" className="flex flex-col gap-3.5">
                  <div className="relative w-full">
                    ...
                    <div className="relative  text-gray-500 focus-within:text-gray-900 ">
                      ...
                      <input
                        type="text"
                        id="default-search"
                        className="block w-full pr-4 pl-12 py-2 text-sm font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none leading-relaxed"
                  ...
                  <button
                    type="submit"
                    id="submit"
                    className="block w-full rounded-lg px-5 py-2.5 text-sm shadow-xs text-white font-medium bg-indigo-600"
                  >
                    Subscribe
                  </button>
                </form>
