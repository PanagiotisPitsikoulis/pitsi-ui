            ...
            <div className="opacity-1 ease-out sm:max-w-sm sm:w-full m-5 relative top-1/2 -translate-y-1/2 sm:mx-auto modal-open:opacity-100 transition-all modal-open:duration-500">
              <div className="bg-white p-6">
                ...
                <div className="flex items-center justify-center my-3.5">
                  <div className="p-3 rounded-full bg-emerald-50"></div>
                </div>
                <h5 className="text-center text-lg font-bold leading-8 text-gray-900 mb-2">
                  Payment Successful!
                </h5>
                ...
                <button
                  className="close-modal-button py-2.5 text-center w-full bg-indigo-600 text-sm font-medium text-white rounded-lg transition-all duration-300 hover:bg-indigo-700"
                  data-pd-overlay="#modalBox-6"
                  data-modal-target="modalBox-6"
                >
                  Confirm
