...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/pitsi/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/pitsi/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/pitsi/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/pitsi/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/pitsi/Projects/foobar/lib/utils")
})
