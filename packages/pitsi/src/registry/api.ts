...
export async function getpitsiRegistryIndex() {
  try {
...
export async function getRegistryIcons() {
  try {
    ...
    // Return empty object instead of calling handleError to avoid process.exit in tests
    return {}
  }
}
...
export async function getRegistryBaseColor(baseColor: string) {
  try {
    ...
    // Return undefined instead of calling handleError to avoid process.exit in tests
    return undefined
  }
}
