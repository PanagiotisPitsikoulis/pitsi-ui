...
Thanks for your interest in contributing to ui.pitsi.com. We're happy to have you here.

Please take a moment to review this document before submitting your first pull request. We also strongly recommend that you check for open issues and pull requests to see if someone else is working on something similar.

If you need any help, feel free to reach out to [@pitsi](https://twitter.com/pitsi).
...
| `packages/pitsi`    | The `pitsi` package.                    |
...
1. To run the `ui.pitsi.com` website:

```bash
pnpm --filter=v4 dev
```

2. To run the `pitsi` package:

```bash
pnpm --filter=pitsi dev
```
...
2. In another terminal tab, test the CLI by running:
   ...
   ```bash
   pnpm pitsi <init | add | ...> -c ~/Desktop/my-app
   ```
...
The `pitsi` package is a CLI for adding components to your project. You can find the documentation for the CLI [here](https://ui.pitsi.com/docs/cli).

Any changes to the CLI should be made in the `packages/pitsi` directory. If you can, it would be great if you could add tests for your changes.
